  ...
  (AMP._ = AMP._ || {}),
    (self.AMP && !Array.isArray(self.AMP)) ||
      (function () {
        ...
        var Gt = function () {
            return "01".concat("2208121708000");
          },
          Vt = function (t, i) {
            return i.reduce(
              function (t, i) {
        ...
        var ri = (function () {
          function t(t) {
            (this.yt = t),
              (this.status = this.yt.status),
              (this.statusText = this.yt.statusText),
          ...
          return (
            (i.clone = function () {
              return et(!this.bodyUsed), new t(this.yt);
            }),
            (i.wt = function () {
              return (
                et(!this.bodyUsed),
                (this.bodyUsed = !0),
                Promise.resolve(this.yt.responseText)
              );
            }),
            (i.text = function () {
              return this.wt();
            ...
            (i.json = function () {
              return this.wt().then(at);
            }),
            (i.arrayBuffer = function () {
              return this.wt().then(ct);
            }),
            t
          );
        })();
        ...
        var si = (function () {
            ...
            return (
              (i.get = function (t) {
                return this.yt.getResponseHeader(t);
              }),
              (i.has = function (t) {
                return null != this.yt.getResponseHeader(t);
              }),
              t
            );
          })(),
        ...
        var qi = (function () {
          function t(i, n) {
            (this.At = i),
              (this.xt = D({ root: null, rootMargin: "0px 0px 0px 0px" }, n)),
              (this.Et = []),
              (this.Ot = null),
              t._upgraders.push(this.Pt.bind(this));
          }
          var n = t.prototype;
          return (
            (n.disconnect = function () {
              this.Ot ? this.Ot.disconnect() : (this.Et.length = 0);
            }),
            (n.takeRecords = function () {
              return this.Ot ? this.Ot.takeRecords() : [];
            }),
            (n.observe = function (t) {
              this.Ot
                ? this.Ot.observe(t)
                : -1 == this.Et.indexOf(t) && this.Et.push(t);
            }),
            (n.unobserve = function (t) {
              if (this.Ot) this.Ot.unobserve(t);
              else {
                var i = this.Et.indexOf(t);
                -1 != i && this.Et.splice(i, 1);
              }
            }),
            (n.Pt = function (t) {
              var i = new t(this.At, this.xt);
              this.Ot = i;
              for (var n, r = o(this.Et, !0); !(n = r()).done; ) {
                var e = n.value;
                i.observe(e);
              }
              this.Et.length = 0;
            ...
            i(t, [
              {
                key: "root",
                get: function () {
                  return this.Ot ? this.Ot.root : this.xt.root || null;
                },
              },
              {
                key: "rootMargin",
                get: function () {
                  return this.Ot ? this.Ot.rootMargin : this.xt.rootMargin;
                },
              },
              {
                key: "thresholds",
          ...
          Er = (function () {
            ...
            return (
              ...
              (i.removeAll = function () {
                this.Un && (this.Un.length = 0);
              }),
              (i.fire = function (t) {
                if (this.Un)
                  for (var i, n = o(this.Un.slice(), !0); !(i = n()).done; )
                    (0, i.value)(t);
              }),
          ...
          Pr = (function () {
            ...
            return (
              ...
              (i.whenSignal = function (t) {
                var i,
                  n = null === (i = this.Tt) || void 0 === i ? void 0 : i[t];
                if (!n) {
                  var r = this.Fn[t];
                  (n =
                    null != r
              ...
              (i.signal = function (t, i) {
                ...
                if (null == this.Fn[t]) {
                  ...
                  this.Fn[t] = r;
                  var e =
                    null === (n = this.Tt) || void 0 === n ? void 0 : n[t];
                  null != e &&
                    e.resolve &&
              ...
              (i.reset = function (t) {
                var i;
                this.Fn[t] && delete this.Fn[t];
                var n = null === (i = this.Tt) || void 0 === i ? void 0 : i[t];
                n && !n.resolve && delete this.Tt[t];
              }),
              t
            );
          })(),
        ...
        var zr = (function () {
          ...
          Br = (function () {
            function t(t, i, n) {
              (this.win = t),
                (this.It = null),
                i &&
                  ((this.It = new Wr(t, { params: Jr(t, n) })),
                  (t.document.__AMPDOC = this.It));
            }
            var i = t.prototype;
            return (
          ...
          $r = (function () {
            function t(t, i, n) {
              ...
              (this.win = t),
                (this.St = A()),
                (this.kt = i),
                (this._t = (n && n.signals) || new Pr()),
                (this.Rt = (n && n.params) || A()),
                (this.Nt = null),
                (this.Ct = {});
              var e,
                s = this.Rt.visibilityState;
              Zt(
                !s ||
                  "prerender" === (e = s) ||
                  "preview" === e ||
                ...
                (this.Dt = (n && n.visibilityState) || s || null),
                (this.J = null),
                (this.jt = new Er()),
                (this.zt = null),
                (this.Ut = []);
              var u = this.Lt.bind(this);
              this.kt && this.Ut.push(this.kt.onVisibilityChanged(u)),
                jr(this.win.document, u),
                this.Ut.push(function () {
            ...
            return (
                  ...
                  this.Nt ||
                    ...
                    this.win.document.head
                      ...
                      .forEach(function (i) {
                        ...
                        n && null !== r && void 0 === t.Nt[n] && (t.Nt[n] = r);
                      })),
                  A(this.Nt)
                );
              }),
              ...
              (i.overrideVisibilityState = function (t) {
                this.Dt != t && ((this.Dt = t), this.Lt());
              }),
              (i.Lt = function () {
                for (
                  var t, i = Dr(this.win.document), n = yr, r = this.kt;
                  r;
                  r = r.getParent()
                )
                ...
                if (
                  ...
                  if (t == yr) {
                    ...
                    null != this.J && (o += Math.floor(u.now())),
                      ...
                      this._t.signal(Vr, o),
                      this._t.signal(Fr, o);
                  } else this._t.reset(Fr);
                  t == br && this._t.signal(qr), (this.J = t), this.jt.fire();
                }
              }),
              ...
              (i.whenFirstPreviewed = function () {
                return this._t.whenSignal(qr).then(function () {});
              }),
              (i.whenFirstVisible = function () {
                return this._t.whenSignal(Vr).then(function () {});
              }),
              (i.whenNextVisible = function () {
                return this._t.whenSignal(Fr).then(function () {});
              }),
              (i.getFirstVisibleTime = function () {
                return this._t.get(Vr);
              }),
              ...
              (i.registerSingleton = function (t) {
                return !this.St[t] && ((this.St[t] = !0), !0);
              }),
              t
            );
          })(),
          Wr = (function (t) {
            ...
            function n(t, n) {
              var r;
              return (
                ((r = i.call(this, t, null, n)).Ht = r.win.document.body
                  ? Promise.resolve(r.win.document.body)
                  : Mi(r.win.document).then(function () {
                      return r.getBody();
                    })),
                (r.Gt = vn(r.win.document)),
                r
              );
            }
            var r = n.prototype;
          ...
          Yr = (function (t) {
            ...
            function n(t, n, r, e) {
              var s;
              ((s = i.call(this, t, null, e)).Vt = n),
                (s.Ft = r),
                (s.Bt = null);
              var u = new a();
              (s.Ht = u.promise), (s.qt = u.resolve), (s.Wt = !1);
              var o = new a();
              return (s.Gt = o.promise), (s.$t = o.resolve), s;
            }
            var r = n.prototype;
            return (
              (r.isSingleDoc = function () {
              ...
              (r.setBody = function (t) {
                Zt(!this.Bt), (this.Bt = t), this.qt(t), (this.qt = void 0);
              }),
              (r.waitForBodyOpen = function () {
                return this.Ht;
              }),
              ...
              (r.setReady = function () {
                Zt(!this.Wt), (this.Wt = !0), this.$t(), (this.$t = void 0);
              }),
              (r.whenReady = function () {
                return this.Gt;
              }),
              ...
              (r.setMetaByName = function (t, i) {
                Zt(t), this.Nt || (this.Nt = A()), (this.Nt[t] = i);
              }),
              n
            );
          })($r),
          Kr = (function (t) {
            ...
            function n(t, n, r, e) {
              var s;
              ((s = i.call(this, t, r, e)).Vt = n),
                (s.Ht = s.win.document.body
                ...
                (s.Wt = !1);
              var u = new a();
              return (s.Gt = u.promise), (s.$t = u.resolve), s;
            }
            var r = n.prototype;
            return (
              (r.isSingleDoc = function () {
        ...
        var pe,
          ...
          Te = (function () {
            function t(t, i) {
              (this.t = t), (this.At = i), (this.Kt = {}), (this.Yt = null);
            }
            var i = t.prototype;
            return (
              (i.start = function () {
                (this.Yt = this.Kt), (this.Kt = {});
              }),
              (i.resolveMatchQuery = function (t) {
                return "1" === this.Jt(t, Se, "1");
              }),
              (i.resolveListQuery = function (t) {
                return this.Jt(t, Re, "");
              }),
              (i.complete = function () {
                for (var t in this.Yt)
                  t in this.Kt || _e(this.Yt[t], this.At, !1);
                this.Yt = null;
              }),
              (i.dispose = function () {
                for (var t in this.Kt) _e(this.Kt[t], this.At, !1);
                this.Kt = {};
              }),
              (i.Jt = function (t, i, n) {
                if (!t.trim()) return n;
                var r = this.Kt[t];
                return (
                  r || (et(this.Yt), (r = this.Yt[t])),
                  r || _e((r = i(this.t, t)), this.At, !0),
                  (this.Kt[t] = r),
                  (function (t) {
        ...
        function ke(t) {
          ...
          return (
            (pe && pe.ownerDocument === i) || (pe = i.createElement("div")), Ce
          );
        }
        function Ce(t) {
          return (function (t, i) {
        ...
        function qe(t) {
          ...
          try {
            ...
            "localStorage" in t &&
              (n =
                null !== (r = t.localStorage.getItem(ze)) && void 0 !== r
                  ? r
                  : "");
          } catch (t) {
        ...
        function Xe(t) {
          ...
          return r && t.__AMP_MEDIA_LOAD_FAILURE_SRC === t.currentSrc
            ...
            : new Promise(function (e, s) {
                if (
                  ((i = r
                    ? Je(t, "loadedmetadata", e, { capture: !0 })
                    : Je(t, "load", e)),
                  t.tagName)
                ) {
                  var u = t;
                ...
                function () {
                  i && i(),
                    (function (t) {
                      ...
                      var i = t;
                      throw (
                        (i && i.src && (i = i.src), Jt().createError($e, i))
                      );
                    })(t);
                },
              );
        ...
        function vs(t, i) {
          return (
            os ||
              ...
              (hs =
                self.__AMP_URL_CACHE || (self.__AMP_URL_CACHE = new as(100)))),
            ds(os, t, i ? null : hs)
          );
        }
        function ds(t, i, n) {
        ...
        function Ls(t, i, n, r, e) {
          var s = this;
          if (
            (!this || !this.document || (e && e.expected) || es(this.document),
            !Dt().development)
          ) {
            var u = !1;
            try {
        ...
        var zs = "Resource",
          Hs = (function () {
            function t(t, i, n) {
              (i.__AMP__RESOURCE = this),
                ...
                (this.Qt = n),
                (this.Zt = i.hasAttribute("placeholder")),
                (this.ti = !1),
                (this.ii = void 0),
                (this.ni = i.isBuilt() ? 1 : 0),
                0 == this.ni && i.isBuilding() && this.build(),
                (this.ri = -1),
                (this.ei = 0),
                (this.si = null),
                (this.oi = null),
                (this.ui = !1),
                (this.hi = zi(-1e4, -1e4, 0, 0)),
                (this.ai = null),
                (this.ci = !1),
                (this.fi = null),
                (this.li = null),
                (this.vi = void 0);
              var r = new a();
              (this.di = r.promise), (this.mi = r.resolve), (this.pi = !1);
            }
            ...
            return (
              ...
              (i.getOwner = function () {
                if (void 0 === this.ii) {
                  for (var t = this.element; t; t = t.parentElement)
                    if (t.__AMP__OWNER) {
                      this.ii = t.__AMP__OWNER;
                      break;
                    }
                  void 0 === this.ii && (this.ii = null);
                }
                return this.ii;
              }),
              (i.hasOwner = function () {
              ...
              (i.build = function () {
                var t = this;
                return this.ti || !this.element.isUpgraded()
                  ? null
                  : ((this.ti = !0),
              ...
              (i.overflowCallback = function (t, i, n, r) {
                t && (this.vi = { height: i, width: n, margins: r }),
              ...
              (i.bi = function () {
                ...
                this.hi = t.getLayoutRect(this.element);
                var i = !1;
                if (t.supportsPositionFixed() && this.isDisplayed())
                  for (
                    var n = this.Qt.getAmpdoc().win,
                      r = n.document.body,
                      e = this.element;
                    e && e != r;
                    e = e.offsetParent
              ...
              (i.completeCollapse = function () {
                kr(this.element, !1),
                  (this.hi = zi(this.hi.left, this.hi.top, 0, 0)),
                  (this.ui = !1),
              ...
              (i.getLayoutSize = function () {
                return (
                  (i = (t = this.hi).height), { width: t.width, height: i }
                );
                var t, i;
              }),
              (i.getLayoutBox = function () {
                ...
                var t = mr(this.element);
                return Gi(this.hi, t.getScrollLeft(), t.getScrollTop());
              }),
              (i.getInitialLayoutBox = function () {
                return this.ai || this.hi;
              }),
              ...
              (i.layoutScheduled = function (t) {
                (this.ni = 3), (this.element.layoutScheduleTime = t);
              }),
              (i.layoutCanceled = function () {
                this.ni = this.hasBeenMeasured() ? 2 : 1;
              }),
              (i.startLayout = function () {
                var t = this;
                if (this.li) return this.li;
                if (4 == this.ni) return h();
                if (5 == this.ni) return Promise.reject(this.oi);
                if ((Zt(0 != this.ni), Zt(this.isDisplayed()), 3 != this.ni)) {
                ...
                if (this.ei > 0 && !this.element.isRelayoutNeeded())
                  return (
                    Qt().fine(
                      zs,
                ...
                Qt().fine(zs, "start layout:", this.debugid, "count:", this.ei),
                  this.ei++,
                  (this.ni = 3),
                  (this.si = new AbortController());
                var n = this.si.signal,
              ...
              (i.yi = function (t, i, n) {
                ...
                if (
                  ...
                  return (
                    Qt().fine(zs, "loading failed:", this.debugid, n),
                    Promise.reject(n)
                  );
                Qt().fine(zs, "layout complete:", this.debugid);
              }),
              (i.isLayoutPending = function () {
                return 4 != this.ni && 5 != this.ni;
              }),
              (i.loadedOnce = function () {
                return this.element.R1() ? this.element.whenLoaded() : this.di;
              }),
              (i.isInViewport = function () {
                return this.pi && this.gi(), this.pi;
              }),
              ...
              (i.unlayout = function () {
                0 != this.ni &&
                  1 != this.ni &&
                  2 != this.ni &&
                  (this.si && (this.si.abort(), (this.si = null)),
          ...
          qs = (function () {
            function t(t) {
              ...
              this.wi = t;
              var n = t.win;
              (this.Ai = new n.IntersectionObserver(
                function (t) {
                  return i.xi(t);
                },
                ...
                (this.Mi = t.onVisibilityChanged(function () {
                  return i.Si();
                }));
            }
            var i = t.prototype;
            return (
              ...
              (i.scheduleAsap = function (t) {
                this.Oi.set(t, { asap: !0, isIntersecting: !1 }), this.ki(t);
              }),
              (i.schedule = function (t) {
                this.Oi.has(t) ||
                  (t.deferredMount()
                    ? (this.Oi.set(t, { asap: !1, isIntersecting: !1 }),
                      this.Ai.observe(t),
                      this.Ei.size > 0 &&
                        this.Ei.forEach(function (i, n) {
                          ji(n, t) && i.observe(t);
                        }))
                    : this.Oi.set(t, { asap: !1, isIntersecting: !0 }),
                  this.ki(t));
              }),
              (i.unschedule = function (t) {
                this.Oi.has(t) &&
                  ...
                  this.Pi && ($(this.Pi, t), this.Ii()));
              }),
              (i.setContainer = function (t, i) {
                var n = this;
                if (!this.Ei.has(t)) {
                  var r = new this.wi.win.IntersectionObserver(
                    function (t) {
                      return n.xi(t);
                    },
              ...
              (i.removeContainer = function (t) {
                var i = this.Ei.get(t);
                i && (i.disconnect(), this.Ei.delete(t));
              }),
              (i._i = function () {
                var t = this;
                this.wi.isReady() &&
                  !this.Ti &&
                  ((this.Ti = !0),
                  this.wi.win.setTimeout(function () {
                    t.wi.signals().signal(Gs);
                  }, 50));
              }),
              (i.Si = function () {
                var t = this,
                  i = this.wi.getVisibilityState();
                (i != yr && i != wr && i != gr && i != br) ||
                  this.Oi.forEach(function (i, n) {
                    return t.Ri(n);
                  });
              ...
              (i.ki = function (t) {
                var i = this.Pi;
                i ? (i.includes(t) || i.push(t), this.Ii()) : this.Ri(t);
              }),
              (i.Ii = function () {
                var t = this.wi.isReady(),
                  i = this.Pi;
                if (i)
                  for (var n = 0; n < i.length; n++) {
                    var r = i[n];
                    (t || ki(r, this.wi.getRootNode())) &&
                      (i.splice(n--, 1), this.Ri(r));
                  }
                t && ((this.Pi = null), this._i());
              }),
              (i.xi = function (t) {
                for (var i = 0; i < t.length; i++) {
                  var n = t[i],
                  ...
                  if (s) {
                    ...
                    u !== s.isIntersecting &&
                      this.Oi.set(e, { asap: s.asap, isIntersecting: u }),
                      u && this.Ri(e);
                  }
                }
              }),
              (i.Ri = function (t) {
                var i = this.Pi,
                  n = !(i && i.includes(t)),
                  r = this.Oi.get(t) || { asap: !1, isIntersecting: !1 },
                  e = r.asap,
                  s = r.isIntersecting,
                  u = this.wi.getVisibilityState();
                if (
                  n &&
                  (e || s) &&
                  (u == yr ||
            ...
            return (
              ...
              (n.Ci = function (t) {
                for (
                  ...
                  if (this.Ni[i].priority < t) n = i + 1;
                  else {
                    if (!(i > 0 && this.Ni[i - 1].priority >= t)) break;
                    r = i - 1;
                  }
                return i;
              }),
              (n.forEach = function (t) {
                for (var i = this.length; i--; ) t(this.Ni[i].item);
              }),
              (n.dequeue = function () {
                var t = this.Ni.pop();
        ...
        var Zs = "not_run",
          tu = (function () {
            ...
            return (
              ...
              (i.Li = function () {
                return this.ji.displayName || this.ji.name;
              }),
              (i.Ui = function (t) {}),
              (i.Hi = function () {
                return !1;
          ...
          iu = (function (t) {
            ...
            return (
              ...
              (r.Fi = function () {
                return this.Vi.ampdoc.isVisible();
              }),
              n
            );
          })(tu),
          nu = (function () {
            function t(t) {
              ...
              (this.ampdoc = t),
                ...
                (this.Ji = !1),
                (this.Di = this.t.document.documentElement.hasAttribute(
                  "i-amphtml-no-boilerplate",
                )),
                this.t.addEventListener("message", function (t) {
                  "amp-macro-task" == Ke(t) && n.$i(null);
                }),
                (this.Bi = !1),
            ...
            return (
              ...
              (i.runForStartup = function (t) {
                ...
                this.Qi(i, Number.POSITIVE_INFINITY);
              }),
              (i.Qi = function (t, i) {
                this.qi.enqueue(t, i), this.Xi();
              }),
              (i.Zi = function (t) {
                for (var i = this.qi.peek(); i && i.state !== Zs; )
                  this.qi.dequeue(), (i = this.qi.peek());
              ...
              (i.$i = function (t) {
                var i,
                  n = this,
                  r = this.Zi(!0);
                if (!r) return (this.Ji = !1), (this.Ki = 0), !1;
                try {
                  (i = Date.now()), r.zi(t);
                } finally {
                  Ks.then()
              ...
              (i.Xi = function () {
                if (!this.Ji) {
                  ...
                  if (t)
                    return t.Hi()
                      ? ((this.Ji = !0), void this.Yn(null))
                      : void (t.Gi() && this.t.requestIdleCallback
                          ? (function (t, i, n, r) {
                              var e = Date.now();
          ...
          eu = (function () {
            ...
            return (
              ...
              (i.attemptChangeHeight = function (t) {
                return rr(this.getAmpDoc()).requestChangeSize(
                  this.element,
                  t,
                  void 0,
                );
              ...
              (i.measureMutateElement = function (t, i, n) {
                return rr(this.getAmpDoc()).measureMutateElement(
                  n || this.element,
                  t,
                  i,
                );
              ...
              var r = (function (r) {
                ...
                return (
                  (u.createdCallback = function () {
                    ...
                    (this.Sr = n === ou ? null : n || null),
                      this.Sr || fu.push(this),
                      (this.kr = null),
                      (this._r = 1),
                      (this.Rr = 0),
                      (this.Nr = void 0),
                      (this.Cr = void 0),
                      (this._t = new Pr()),
                      this.Sr && this._t.signal(we);
                    var r = (function (t, i) {
                      return zn((t = Tn(t)), i) ? kn(t, i) : null;
                    })(t, "performance");
                    (this.Dr = r && r.isPerformanceTrackingOn()),
                      (this.jr = null),
                      i.__AMP_UPG_RES &&
                        (i.__AMP_UPG_RES(i),
                  ...
                  (u.getAmpDoc = function () {
                    return Zt(this.wi), this.wi;
                  }),
                  (u.getResources = function () {
                    return Zt(this.Qt), this.Qt;
                  }),
                  (u.isUpgraded = function () {
                    return 2 == this._r;
                  }),
                  (u.whenUpgraded = function () {
                    return this._t.whenSignal(Ae);
                  }),
                  ...
                  (u.Lr = function () {
                    this.Tr != Qr &&
                      this.kr &&
                      !this.kr.isLayoutSupported(this.Tr) &&
                      (ti(
                      ...
                      ti(!1, "Layout not supported: ".concat(this.Tr)));
                  }),
                  (u.getBuildPriority = function () {
                    return this.Sr ? this.Sr.getBuildPriority(this) : 3;
                  }),
                  ...
                  (u.getDefaultActionAlias = function () {
                    return (
                      Zt(this.isUpgraded()), this.kr.getDefaultActionAlias()
                    );
                  }),
                  ...
                  (u.whenBuilt = function () {
                    return this._t.whenSignal(xe);
                  }),
                  (u.buildInternal = function () {
                    var t = this;
                    if ((mu(this), Zt(this.Sr), this.gr)) return this.gr;
                    this.setReadyStateInternal(en);
                    var i = this.Hr();
                    this.Gr();
                    var n = i
                      .then(function () {
                        ...
                        if (n || r)
                          return ((i = t),
                          Gn(i, "consentPolicyManager", "amp-consent"))
                            .then(function (t) {
                              return (
                                !t ||
                                (n
                    ...
                    return (this.gr = n.then(
                      function () {
                        if (
                          ...
                          t._t.signal(xe),
                          t.R1()
                            ? t.setReadyStateInternal(t.Pr != en ? t.Pr : sn)
                            : (t.setReadyStateInternal(un), t.preconnect(!1)),
                          t.br && t.an(),
                          t.Nr && ar(oi(t)).delay(t.Br.bind(t), 1),
                          !t.getPlaceholder())
                        ) {
                  ...
                  (u.build = function () {
                    ...
                    return this.gr
                      ? this.gr
                      : this._t.whenSignal(we).then(function () {
                          return (
                            t.R1() && Bs(t.getAmpDoc()).scheduleAsap(t),
                            t.whenBuilt()
                          );
                        });
                  }),
                  (u.mountInternal = function () {
                    ...
                    this.Or = this.Or || new AbortController();
                    var i = this.Or.signal;
                    return (this.Er = this.buildInternal()
                      .then(function () {
                        if ((Zt(t.R1()), !i.aborted)) {
                          t.setReadyStateInternal(
                            t.Pr != sn ? t.Pr : t.Sr.usesLoading(t) ? un : sn,
                          ),
                            (t.Ar = !0);
                      ...
                      .then(function (n) {
                        if (((t.Or = null), i.aborted)) throw js();
                        t._t.signal(Ee),
                          (t.Sr.usesLoading(t) && !n) ||
                        ...
                        throw (
                          ...
                          ("string" == typeof n
                            ...
                            : "string" == typeof n.message &&
                              n.message.startsWith(_s))
                            ? (t.Er = null)
                            : (t._t.rejectSignal(Ee, i),
                  ...
                  (u.mount = function () {
                    ...
                    this.Or = this.Or || new AbortController();
                    var i = this.Or.signal;
                    return this._t.whenSignal(we).then(function () {
                  ...
                  (u.unmount = function () {
                    this.br && this.pause(),
                      this.R1()
                        ? (this.Or && (this.Or.abort(), (this.Or = null)),
                          Bs(this.getAmpDoc()).unschedule(this),
                          this.Ar && this.kr.unmountCallback(),
                          (this.Ar = !1),
                          (this.Er = null),
                          this.qr(),
                          this.br && this.zr(!0))
                  ...
                  (u.whenMounted = function () {
                    return this._t.whenSignal(Ee);
                  }),
                  (u.whenLoaded = function () {
                    return this._t.whenSignal(Ie);
                  }),
                  (u.ensureLoaded = function (t) {
                    ...
                    return this.mount().then(function () {
                      if (i.R1())
                        return (
                          i.Sr.usesLoading(i) && i.kr.ensureLoaded(),
                          i.whenLoaded()
                        );
                      var n = i.$r();
                  ...
                  (u.setReadyStateInternal = function (t, i) {
                    if (t !== this.Pr && ((this.Pr = t), this.R1()))
                      switch (t) {
                        case un:
                          return (
                            this._t.signal(Pe),
                  ...
                  (u.R1 = function () {
                    return !!this.Sr && this.Sr.R1();
                  }),
                  (u.deferredMount = function () {
                    return !!this.Sr && this.Sr.deferredMount(this);
                  }),
                  ...
                  (u.Xr = function () {
                    this.jr && (this.jr.dispose(), (this.jr = null));
                  }),
                  (u.Jr = function () {
                    var t = this.jr;
                    if (t) {
                      ...
                      var e =
                        this.Tr === ie ? this.getAttribute("heights") : null;
                      if (e) {
                        var s = this.Gr();
                        s && Rr(s, "paddingTop", t.resolveListQuery(e));
                      }
                      t.complete(), this.$r().requestMeasure();
                    }
                  }),
                  (u.applySize = function (t, i, n) {
                    ...
                    r &&
                      ...
                      n &&
                        ...
                        null != n.right &&
                          Rr(this, "marginRight", n.right, "px"),
                        null != n.bottom &&
                          Rr(this, "marginBottom", n.bottom, "px"),
                  ...
                  (u.connectedCallback = function () {
                    if (
                      ((function () {
                        ...
                        void 0 !== this.Cr ||
                        (this.Cr = !!yi(this, "template")),
                      !this.Cr && !this.br && Ri(this))
                    ) {
                      if (
                        ((this.br = !0),
                        this.everAttached ||
                        ...
                        (this.wi = i), n(i, this, this.Sr);
                      }
                      if (
                        (this.Qt || (this.Qt = or(this.wi)),
                        ...
                        this.Sr
                          ? this.zr()
                          : (lu.has("*") ||
                              lu.has(this.tagName.toLowerCase())) &&
                            this.markUnresolved(),
                          this.isUpgraded() ||
                      ...
                      if (!this.Er)
                        if (
                          ...
                          this.setReadyStateInternal(
                            this.Sr && this.Sr.usesLoading(this) ? un : sn,
                          );
                        else if ((this.setReadyStateInternal(en), !t)) {
                          var i = this.Sr.getPreconnects(this);
                          if (i && i.length > 0) {
                  ...
                  (u.ie = function () {
                    var i = this;
                    if (!this.Cr && 1 == this._r) {
                      var n = new (Zt(this.Sr))(this);
                      this._r = 4;
                      var r = t.Date.now(),
                        e = n.upgradeCallback();
                      if (e) {
                  ...
                  (u.an = function () {
                    this.Qn && this.kr.attachedCallback();
                  }),
                  ...
                  (u.prerenderAllowed = function () {
                    return (
                      ...
                      !!this.Sr &&
                      this.Sr.prerenderAllowed(this)
                    );
                  }),
                  (u.previewAllowed = function () {
                    return !!this.Sr && this.Sr.previewAllowed(this);
                  }),
                  ...
                  (u.createLoaderLogo = function () {
                    return this.Sr
                      ? this.Sr.createLoaderLogoCallback(this)
                      : {};
                  }),
                  ...
                  (u.getLayoutBox = function () {
                    return this.$r().getLayoutBox();
                  }),
                  (u.getLayoutSize = function () {
                    return this.$r().getLayoutSize();
                  }),
                  (u.getOwner = function () {
                    return this.$r().getOwner();
                  }),
                  ...
                  (u.layoutCallback = function (t) {
                    var i = this;
                    if ((mu(this), Zt(this.isBuilt()), t.aborted))
                  ...
                  (u.pause = function () {
                    this.isBuilt() &&
                      ...
                      !this.R1() && this.kr.unlayoutOnPause() && this.Wr());
                  }),
                  (u.resume = function () {
                  ...
                  (u.Wr = function () {
                    this.$r().unlayout(),
                      this.br && this.Qt && this.Qt.schedulePass();
                  }),
                  (u.qr = function () {
                    (this.ei = 0),
                      (this.Ir = !1),
                  ...
                  (u.getOverflowElement = function () {
                    return (
                      void 0 === this.Mr &&
                        ((this.Mr = Ai(this, "overflow")),
                        this.Mr &&
                          (this.Mr.hasAttribute("tabindex") ||
                            this.Mr.setAttribute("tabindex", "0"),
                          this.Mr.hasAttribute("role") ||
                            this.Mr.setAttribute("role", "button"))),
                      this.Mr
                    );
                  }),
                  (u.overflowCallback = function (t, i, n) {
                    ...
                    this.getOverflowElement(),
                      this.Mr
                        ? (this.Mr.classList.toggle("amp-visible", t),
                          (this.Mr.onclick = t
                            ? function () {
                  ...
                  (u.Qr = function (t, i) {
                    var n =
                      ...
                      arguments[2];
                    this.wi
                      ? rr(this.getAmpDoc()).mutateElement(i || this, t, n)
                      : t();
                  }),
                  i(s, [
                    {
        ...
        function Ou(t, i, n) {
          ...
          n ||
            ...
            tr(t.win).installExtensionForDoc(t, r, "0.1");
        }
        var Iu = "amp-img",
          Mu = [
            "alt",
          ...
          Tu = (function (t) {
            ...
            return (
              (r.mutatedAttributesCallback = function (t) {
                if (this.se) {
                  ...
                  t.src &&
                    ...
                    me(i, this.element, this.se, !0),
                    this.propagateDataset(this.se),
                    Xr(this.se),
                    n.R1() && !this.se.complete && this.setReadyState(un);
                }
              }),
              ...
              (r.ae = function () {
                if (this.se) return this.se;
                this.ee = !this.element.hasAttribute("fallback");
                var t,
                  i,
                  n = Ui(this.element);
                return (
                  n && (this.se = pi(this.element, "> img:not([placeholder])")),
                  (this.se = this.se || new Image()),
                  this.se.setAttribute("decoding", "async"),
                  this.element.id &&
                    this.se.setAttribute("amp-img-id", this.element.id),
                ...
                if (
                  ...
                  if (n && !/[0-9]+x(?:,|$)/.test(n)) {
                    ...
                    if (this.fe(r)) {
                      ...
                      var h = s + u;
                      t
                        ? this.se.setAttribute("sizes", h)
                        : this.mutateElement(function () {
                            i.se.setAttribute("sizes", h);
                          }),
                        (this.he = r);
                    }
                  }
              ...
              (r.fe = function (t) {
                return !this.se.hasAttribute("sizes") || t > this.he;
              }),
              ...
              (r.mountCallback = function () {
                ...
                i ||
                  (Ye(n, "load", function () {
                    t.setReadyState(on), t.firstLayoutCompleted(), t.le();
                  }),
                  Ye(n, "error", function (i) {
                    t.setReadyState(hn, i), t.ve();
                  })),
                  n.complete
              ...
              (r.le = function () {
                !this.ee &&
                  this.se.classList.contains("i-amphtml-ghost") &&
                  (this.se.classList.remove("i-amphtml-ghost"),
                  this.toggleFallback(!1));
              }),
              (r.ve = function () {
                this.ee &&
                  (this.se.classList.add("i-amphtml-ghost"),
        ...
        var _u = "amp-pixel",
          ku = (function (t) {
            ...
            function n(t) {
              var n;
              return ((n = i.call(this, t)).de = null), n;
            }
            var r = n.prototype;
            return (
              (r.isLayoutSupported = function (t) {
              ...
              (r.buildCallback = function () {
                this.element.setAttribute("aria-hidden", "true"),
                  (this.me = this.element.getAttribute("referrerpolicy")),
                  this.me &&
                    ti(
                      "no-referrer" == this.me,
                      ""
                        .concat(_u, ': invalid "referrerpolicy" value "')
                        .concat(this.me, '".') +
                  ...
                  this.element.querySelector("img")
                    ...
                    : this.getAmpDoc()
                        .whenFirstVisible()
                        .then(this.pe.bind(this));
              }),
              (r.pe = function () {
                var t = this;
                if (this.de) return Qt().error(_u, "duplicate pixel"), this.de;
                this.de = ar(this.win)
                  .promise(1)
                  .then(function () {
          ...
          Cu = (function () {
            ...
            return (
              ...
              (i.schedule = function (t) {
                ...
                var n = Date.now() + i;
                return (
                  (!this.isPending() || n - this.xe < -10) &&
                  (this.cancel(),
                  (this.xe = n),
                  (this.Ae = this.ge.delay(this.Oe, i)),
                  !0)
                );
              }),
              (i.Pe = function () {
              ...
              (i.cancel = function () {
                this.isPending() && (this.ge.cancel(this.Ae), (this.Ae = -1));
              }),
              t
            );
          })();
          ...
          Bu = (function () {
            function t(t, i) {
              (this.ampdoc = t),
                ...
                (this.Ie = this.ampdoc.isSingleDoc() && Du(this.Te)),
                (this.Me = this.Ie ? Vu : null),
                (this.Se = A()),
                (this.ke = A()),
                this.addEvent("tap"),
            ...
            return (
              ...
              (i.addGlobalMethodHandler = function (t, i) {
                var n =
                  arguments.length > 2 && void 0 !== arguments[2]
                    ? arguments[2]
                    : 2;
                this.ke[t] = { handler: i, minTrust: n };
              }),
              (i.trigger = function (t, i, n, r, e) {
                return this.Re(t, i, n, r, e);
              }),
              ...
              (i.De = function (t) {
                return this.Se[t] ? this.Te : this.Te.getElementById(t);
              }),
              ...
              (i.addToAllowlist = function (t, i, n) {
                ...
                (n && n.includes("email") !== this.Ie) ||
                  ...
                  V(i) || (i = [i]),
                  i.forEach(function (i) {
                    r.Me.some(function (n) {
                      return n.tagOrTarget == t && n.method == i;
                    }) || r.Me.push({ tagOrTarget: t, method: i });
                  }));
              }),
              (i.Re = function (t, i, n, r, e) {
                var s = this,
                  u = this.Ce(t, i);
                if (!u) return !1;
                var h = Math.random(),
              ...
              (i.Ne = function (t) {
                ...
                if (
                  ...
                  var h = e[Hu];
                  return (
                    h ? h(t) : ((e[zu] = e[zu] || []), e[zu].push(t)), null
                  );
                }
                return (
                  this.je(
        ...
        function Ku(t, i) {
          ...
          do {
            if (
              (n = o.next()).type == Zu.EOF ||
              (n.type == Zu.SEPARATOR && ";" == n.value)
            );
          ...
          io = (function () {
            ...
            return (
              ...
              (i.Ge = function (t) {
                var i = this.He + 1;
                if (i >= this.Le.length)
                  return { type: Zu.EOF, index: this.He };
                var n = this.Le.charAt(i);
                if (-1 != to.indexOf(n)) {
                  for (
                    i++;
                    i < this.Le.length && -1 != to.indexOf(this.Le.charAt(i));
                    i++
                  );
                  if (i >= this.Le.length) return { type: Zu.EOF, index: i };
                  n = this.Le.charAt(i);
                }
                if (
                  t &&
                  (no(n) ||
                    ("." == n && i + 1 < this.Le.length && no(this.Le[i + 1])))
                ) {
                  for (var r = "." == n, e = i + 1; e < this.Le.length; e++) {
                    var s = this.Le.charAt(e);
                    if ("." != s) {
                      if (!no(s)) break;
                    } else r = !0;
                  }
                  var u = this.Le.substring(i, e),
                    o = r ? parseFloat(u) : parseInt(u, 10);
                  return (i = e - 1), { type: Zu.LITERAL, value: o, index: i };
                }
                if (-1 != ";:.()=,|!".indexOf(n))
                  return { type: Zu.SEPARATOR, value: n, index: i };
                if (-1 != "\"'".indexOf(n)) {
                  for (var h = -1, a = i + 1; a < this.Le.length; a++)
                    if (this.Le.charAt(a) == n) {
                      h = a;
                      break;
                    }
                  if (-1 == h) return { type: Zu.INVALID, index: i };
                  var c = this.Le.substring(i + 1, h);
                  return (i = h), { type: Zu.LITERAL, value: c, index: i };
                }
                if ("{" == n) {
                  for (var f = 1, l = -1, v = i + 1; v < this.Le.length; v++) {
                    var d = this.Le[v];
                    if (("{" == d ? f++ : "}" == d && f--, f <= 0)) {
                      l = v;
                      break;
        ...
        function ho(t, i, n) {
          return (
            et("string" == typeof i), !1 !== n.ampCors && (i = Ss(t, i)), i
          );
        }
        function ao(t, i) {
          var n,
          ...
          return (
            ...
            (r.method =
              void 0 === (n = r.method)
                ? "GET"
                : ((n = n.toUpperCase()), et(eo.includes(n)), n)),
            (r.headers = r.headers || {}),
        ...
        var lo = (function () {
            function t(t) {
              this.win = t;
              var i = Yn(t);
              this.Ve = i.isSingleDoc() ? i.getSingleDoc() : null;
            }
            var i = t.prototype;
            return (
              (i.Fe = function (t, i) {
                var n = arguments,
                  r = this;
                return oo(this.win, this.Ve, t, i).then(function (t) {
                  if (t) return t;
                  if (ro(i.body)) {
                    var e = i.body;
              ...
              (i.fetch = function (t, i) {
                var n = ao(i);
                return this.Be(t, n).then(function (t) {
                  return fo(t);
                });
              }),
              (i.sendSignal = function (t, i) {
                return this.Be(t, i).then(function (t) {
                  return fo(t);
                });
              }),
            ...
            return (
              (r.fetch = function (i, n) {
                var r = this,
                  ...
                  o = !!this.qe[u];
                if (s && o)
                  return this.qe[u].then(function (t) {
                    return t.clone();
                  });
                ...
                return (
                  s &&
                    (this.qe[u] = h.then(
                      function (t) {
                        return delete r.qe[u], t.clone();
                      },
                      function (t) {
                        throw (delete r.qe[u], t);
                      },
                    )),
                  h
                );
          ...
          yo = (function () {
            function t(t) {
              (this.wi = t),
                (this.$e = vr(this.wi)),
                (this.Ke = null),
                (this.ge = ar(this.wi.win));
            }
            var i = t.prototype;
            return (
              (i.isSupported = function () {
                return this.$e.isCctEmbedded() && this.$e.isProxyOrigin();
              }),
              (i.getScopedCid = function (t) {
                var i = this;
                return this.$e.isCctEmbedded()
                  ? (this.Ke ||
                      (this.Ke = this.Ye(
                        "https://ampcid.google.com/v1/cache:getClientId?key=AIzaSyDKtqGxnoeIqVM33Uf7hRSa3GJxuzR7mLc",
                      )),
                    this.Ke.then(function (n) {
                      return n ? i.Je(n, t) : null;
                    }))
              ...
              (i.Ye = function (t) {
                var i = this,
                  n =
                    !(arguments.length > 1 && void 0 !== arguments[1]) ||
                    arguments[1],
                  r = { publisherOrigin: Ms(this.wi.win.location) },
                  e = "fetchCidTimeout";
                return this.ge
                  .timeoutPromise(
                    3e4,
                    pr(this.wi.win).fetchJson(t, {
                      method: "POST",
                      ampCors: !1,
                      credentials: "include",
                      mode: "cors",
        ...
        var Io = "GoogleCidApi",
          ...
          Co = (function () {
            function t(t) {
              (this.t = t.win), (this.ge = ar(this.t)), (this.Xe = {});
              var i = Zn(t).canonicalUrl;
              this.Qe = i ? vs(i).origin : null;
            }
            var i = t.prototype;
            return (
              (i.getScopedCid = function (t, i) {
                ...
                return this.Xe[i]
                  ...
                  : (this.Xe[i] = this.ge
                      ...
                      .then(function () {
                        if (n === So) return So;
                        if ((n !== Ro || !r.Ze()) && r.ts(n)) return null;
                        (n && !r.ts(n)) || r.ns(To, _o);
                        var e =
                          ...
                          .then(function (e) {
                            ...
                            if (!s && e.alternateUrl) {
                              var u = ""
                                ...
                                .concat(t);
                              return r.Ye(u, i, n).then(r.R.bind(r));
                            }
                            return s;
                          })
                          .catch(function (t) {
              ...
              (i.Ye = function (t, i, n) {
                var r = { originScope: i, canonicalOrigin: this.Qe };
                return (
                  n && (r.securityToken = n),
                  this.ge.timeoutPromise(
                    _o,
                    pr(this.t)
                      .fetchJson(t, {
                        method: "POST",
              ...
              (i.R = function (t) {
                return t.optOut
                  ? (this.ns(So, ko), So)
                  : t.clientId
                    ? (this.ns(t.securityToken, ko), t.clientId)
                    : (t.alternateUrl || this.ns(Ro, 36e5), null);
              }),
              (i.ns = function (t, i) {
                t &&
                  xo(this.t, Mo, t, this.rs(i), { highestAvailableDomain: !0 });
              }),
              (i.rs = function (t) {
          ...
          No = (function () {
            function t(t) {
              (this.wi = t), (this.$e = vr(this.wi));
              var i = Zn(this.wi).canonicalUrl;
              this.Qe = i ? vs(i).origin : null;
            }
            var i = t.prototype;
            return (
              (i.isSupported = function () {
                return this.$e.hasCapability("cid")
                  ? this.$e.isTrustedViewer()
                  : Promise.resolve(!1);
              }),
              (i.getScopedCid = function (t, i) {
                var n = {
                  scope: i,
                  clientIdApi: !!t,
                  canonicalOrigin: this.Qe,
                };
                return (
                  t && (n.apiKey = t),
                  this.$e.sendMessageAwaitResponse("cid", n)
                );
              }),
              t
            );
            ...
            return (
              ...
              (i.fs = function (t, i) {
                ...
                if (!xs(e)) {
                  var s = this.ls(r);
                  return s
                    ? this.hs.getScopedCid(s, r).then(function (e) {
                        if (e == So) return null;
                        if (e) {
                ...
                return this.us.isSupported().then(function (t) {
                  if (t) {
                    var s = n.ls(r);
                    return n.us.getScopedCid(s, r);
                  }
                  return n.os.isSupported() && n.ls(r)
                    ? n.os.getScopedCid(r).then(function (t) {
                        return t || n.vs(i, r, e);
                      })
                    : n.vs(i, r, e);
                });
                ...
                return (function (t, i) {
                  ...
                  return Qn(r.ampdoc.win).sha384Base64(
                    t +
                      (function (t) {
                        return (
                          ti(xs(t), "Expected proxy origin %s", t.origin), Ms(t)
                        );
                      })(n) +
                      i,
                  );
              ...
              (i.ls = function (t) {
                return this.cs || (this.cs = this.ds()), this.cs[t];
              }),
              (i.ds = function () {
                var t = {},
        ...
        function Bo(t, i, n) {
          ...
          return (function (t, i) {
            ...
            if (h)
              return (
                /^amp-/.test(h) && (Vo(e, o, h), s || Fo(r, o, h)),
                Promise.resolve(h)
              );
            if (t.ss[u]) return t.ss[u];
        ...
        var Jo = "Crypto",
          Xo = (function () {
            ...
            return (
              (i.sha384 = function (t) {
                var i = this;
                if (
                  ("string" == typeof t && (t = ft(t)), !this.subtle || this.bs)
                )
                  return (this.bs || this.gs()).then(function (i) {
                    return i(t);
                  });
                try {
              ...
              (i.importPkcsKey = function (t) {
                ...
                var i = this.ps ? ct(JSON.stringify(t)) : t;
          ...
          Zo = (function () {
            function t(t) {
              (this.wi = t), (this.ys = null), (this.ws = null);
            }
            return (
              (t.prototype.get = function () {
                if (this.ys) return this.ys;
                var t = this.wi,
                  i = Is(t.getUrl()),
                  n = t.getRootNode(),
                ...
                return (this.ys = {
                  ...
                  pageViewId: u,
                  get pageViewId64() {
                    return this.ws || (this.ws = Ko(t.win)), this.ws;
                  },
                  linkRels: o,
                  viewport: h,
                  replaceParams: a,
          ...
          ih = (function () {
            function t(t) {
              ...
              (this.t = Zt(i.defaultView)), (this.ht = null), (this.As = null);
            }
            var i = t.prototype;
            return (
              (i.add = function (t) {
                ...
                var n = this.As.add(t);
                return function () {
                  n(), 0 === i.As.getHandlerCount() && i.dispose();
                };
              }),
              (i.xs = function () {
                var t = this;
                if (!this.ht) {
                  ...
                  (this.ht = i), i.observe(this.Te, th);
                }
              }),
              (i.dispose = function () {
                this.ht &&
        ...
        var rh = "History",
          ...
          sh = (function () {
            function t(t, i) {
              (this.wi = t),
                ...
                (this.Ps = []),
                (this.Ni = []),
                this.Es.setOnStateUpdated(this.Ts.bind(this));
            }
            var i = t.prototype;
            return (
              (i.cleanup = function () {
              ...
              (i.push = function (t, i) {
                ...
                return this.Is(function () {
                  return n.Es.push(i).then(function (i) {
                    return n.Ts(i), t && (n.Ps[i.stackIndex] = t), i.stackIndex;
                  });
                }, "push");
              }),
              (i.pop = function (t) {
                var i = this;
                return this.Is(function () {
                  return i.Es.pop(t).then(function (t) {
                    i.Ts(t);
                  });
                }, "pop");
              }),
              ...
              (i.replaceStateForTarget = function (t) {
                var i = this;
                Zt("#" == t[0]);
                var n = this.wi.win.location.hash;
                return this.push(function () {
                  i.wi.win.location.replace(n || "#");
                }).then(function () {
                  i.Es.replaceStateForTarget(t);
                });
              }),
              (i.getFragment = function () {
                return this.Es.getFragment();
              }),
              (i.updateFragment = function (t) {
                return (
                  "#" == t[0] && (t = t.substr(1)), this.Es.updateFragment(t)
                );
              }),
              (i.Ts = function (t) {
                (this.Os = t.stackIndex), this.Ms(t);
              }),
              (i.Ms = function (t) {
                var i = this;
                if (!(this.Os >= this.Ps.length - 1)) {
                  for (var n = [], r = this.Ps.length - 1; r > this.Os; r--)
                    this.Ps[r] && (n.push(this.Ps[r]), (this.Ps[r] = void 0));
                  if ((this.Ps.splice(this.Os + 1), n.length > 0))
                    for (
                      var e = function (r) {
                          i.ge.delay(function () {
                            return n[r](t);
                  ...
                  i.then(
                    ...
                    function (t) {
                      Qt().error(rh, "failed to execute a task:", t),
                        n.trace &&
                          ((n.trace.message += t), Qt().error(rh, n.trace)),
                        n.reject(t);
                    },
                  ).then(function () {
                    t.Ni.splice(0, 1), t.Ss();
                  });
                }
              }),
              t
          ...
          uh = (function () {
            function t(t) {
              var i = this;
              (this.win = t), (this.ge = ar(t));
              var n = this.win.history;
              this.ks = n.length - 1;
              var r,
                e,
                s = nh(n);
              s && void 0 !== s[eh] && (this.ks = Math.min(s[eh], this.ks)),
                (this.Os = this.ks),
                this._s,
                (this.Ts = null),
                (this.Rs = "state" in n),
                (this.Ns = this.Cs(this.Os)),
                n.pushState && n.replaceState
                  ? ((this.Ds = n.originalPushState || n.pushState.bind(n)),
                    (this.js =
                    ...
                    (e = function (t, n, r) {
                      i.Ns = t;
                      try {
                        void 0 !== r ? i.js(t, n, r) : i.js(t, n);
                      } catch (t) {
                        Qt().error(rh, "replaceState failed: " + t.message);
                      }
                    }),
                    n.originalPushState || (n.originalPushState = this.Ds),
                    n.originalReplaceState ||
                      (n.originalReplaceState = this.js))
                  : ((r = function (t, n, r) {
                      i.Ns = t;
                    }),
                    (e = function (t, n, r) {
              ...
              (n.pushState = this.Ls.bind(this)),
                ...
                this.win.addEventListener("popstate", this.Gs);
            }
            var i = t.prototype;
            return (
              (i.cleanup = function () {
                this.Ds && (this.win.history.pushState = this.Ds),
                  this.js && (this.win.history.replaceState = this.js),
                  this.win.removeEventListener("popstate", this.Gs);
              }),
              (i.Cs = function (t, i) {
                var n = A(i ? this.Fs() : void 0);
                return (n[eh] = t), n;
              }),
              ...
              (i.pop = function (t) {
                var i = this;
                return (
                  (t = Math.max(t, this.ks)),
                  this.Bs(function () {
                    return i.Ws(i.Os - t + 1);
                  }).then(function (t) {
                    return i.qs(i.Fs(), { stackIndex: t });
                  })
                );
              }),
              (i.replace = function () {
                ...
                return this.Bs(function () {
                  ...
                  return (
                    t.Hs(n, n.title, r || e ? r + e : void 0),
                    c(function () {
                      return t.qs(n, { stackIndex: t.Os });
                    })
                  );
                });
              }),
              (i.get = function () {
                var t = this;
                return c(function () {
                  return t.qs(t.Fs(), { stackIndex: t.Os });
                });
              }),
              (i.backTo = function (t) {
                var i = this;
              ...
              (i.Vs = function () {
                ...
                (this._s = void 0),
                  ...
                  t || (t = {}),
                  (t[eh] = n),
                  this.Us(t, void 0, void 0),
                  n != this.Os && this.$s(this.qs(t, { stackIndex: n })),
                  n < this.ks && (this.ks = n),
                  r && r.resolve();
              }),
              (i.Fs = function () {
                return this.Rs ? nh(this.win.history) : this.Ns;
              }),
              (i.Ks = function () {
                Zt(!this._s);
              }),
              (i.Bs = function (t) {
                return this._s ? this._s.promise.then(t, t) : t();
              }),
              (i.Ys = function () {
                this.Ks();
                var t = new a(),
                  i = t.reject,
                  n = t.resolve,
                  r = this.ge.timeoutPromise(500, t.promise);
                return (this._s = { promise: r, resolve: n, reject: i }), r;
              }),
              (i.Ws = function (t) {
                var i = this;
                if ((this.Ks(), t <= 0)) return Promise.resolve(this.Os);
                this.Ns = this.Cs(this.Os - t);
                var n = this.Ys();
                return (
                  this.win.history.go(-t),
                  n.then(function () {
                    return Promise.resolve(i.Os);
                  })
                );
              }),
              (i.Ls = function (t, i, n) {
              ...
              (i.replaceStateForTarget = function (t) {
                ...
                Zt("#" == t[0]),
                  this.Bs(function () {
                    i.win.removeEventListener("popstate", i.Gs);
                    try {
                      i.win.location.replace(t);
                    } finally {
                      i.win.addEventListener("popstate", i.Gs);
                    }
                    return i.Hs(), h();
                  });
              }),
              (i.Hs = function (t, i, n) {
                this.Ks(), t || (t = {});
                var r = Math.min(this.Os, this.win.history.length - 1);
                (t[eh] = r), this.Us(t, i, n);
                var e = this.qs(t, { stackIndex: r });
                this.$s(e);
              }),
              (i.$s = function (t) {
                this.Ks(),
                  ...
                  this.Os != t.stackIndex &&
                    (Qt().fine(
                      rh,
                      "stack index changed: " + this.Os + " -> " + t.stackIndex,
                    ),
                    (this.Os = t.stackIndex),
                    this.Ts && this.Ts(t));
              }),
          ...
          oh = (function () {
            function t(t, i) {
              ...
              (this.win = t),
                ...
                (this.Os = 0),
                (this.Ts = null),
                (this.Js = this.$e.onMessage("historyPopped", function (t) {
                  return n.Xs(t);
                }));
            }
            var i = t.prototype;
            return (
              ...
              (i.Qs = function (t, i, n) {
                return this.Zs(t)
                  ? t
                  : (Qt().warn(rh, 'Ignored unexpected "%s" data:', n, t), i);
              }),
              (i.Zs = function (t) {
              ...
              (i.pop = function (t) {
                var i = this;
                if (t > this.Os) return this.get();
                var n = { stackIndex: this.Os },
                  r = "popHistory";
                return this.$e
                  .sendMessageAwaitResponse(r, n)
                  .then(function (t) {
                    var n = { stackIndex: i.Os - 1 },
                      e = i.Qs(t, n, r);
                    return i.$s(e), e;
                  });
              }),
              (i.replace = function (t) {
                var i = this;
                if (t && t.url) {
                  if (!this.$e.hasCapability("fullReplaceHistory")) {
                    var n = { stackIndex: this.Os };
              ...
              (i.$s = function (t) {
                ...
                this.Os != i &&
                  (Qt().fine(
                    rh,
                    "stackIndex: ".concat(this.Os, " -> ").concat(i),
                  ),
                  (this.Os = i),
                  this.Ts && this.Ts(t));
              }),
              (i.getFragment = function () {
                return this.$e.hasCapability("fragment")
                  ? this.$e
              ...
              (i.updateFragment = function (t) {
                return this.$e.hasCapability("fragment")
                  ? this.$e.sendMessageAwaitResponse(
                      "replaceHistory",
                      { fragment: t },
                      !0,
                    )
            ...
            return (
              ...
              (i.io = function (t) {
                var i = t.boundingClientRect,
                  ...
                  h = this.ro.get(u);
                o !== ((h && h.shown) || !1) &&
                  (o && !h && ((h = this.so(u, s, e)), this.ro.set(u, h)),
                  h &&
                    ((h.shown = o),
              ...
              (i.eo = function (t) {
                var i = this.ro.get(t);
                i && (this.ro.delete(t), Ti(i.container));
              }),
              t
            );
          })(),
          lh = (function () {
            function t(t, i) {
              ...
              (this.win = t),
                ...
                (this.ho = new Er()),
                (this.ao = function (t) {
                  K(t.target) && n.co(t.target);
                }),
                (this.fo = function (i) {
                  ar(t).delay(function () {
                    n.win.document.activeElement &&
                      n.co(n.win.document.activeElement);
                  }, 500);
                }),
                this.win.document.addEventListener("focus", this.ao, !0),
                this.win.addEventListener("blur", this.fo);
            }
            var i = t.prototype;
            return (
              (i.eo = function () {
                this.win.document.removeEventListener("focus", this.ao, !0),
                  this.win.removeEventListener("blur", this.fo);
              }),
              (i.onFocus = function (t) {
                return this.ho.add(t);
              }),
              (i.co = function (t) {
                var i = Date.now();
                0 == this.uo.length || this.uo[this.uo.length - 1].el != t
                  ? this.uo.push({ el: t, time: i })
                  : (this.uo[this.uo.length - 1].time = i),
                  this.purgeBefore(i - this.oo),
                  this.ho.fire(t);
              }),
              (i.getLast = function () {
                return 0 == this.uo.length
                  ? null
                  : this.uo[this.uo.length - 1].el;
              }),
              (i.purgeBefore = function (t) {
                for (var i = this.uo.length - 1, n = 0; n < this.uo.length; n++)
                  if (this.uo[n].time >= t) {
                    i = n - 1;
                    break;
                  }
                -1 != i && this.uo.splice(0, i + 1);
              }),
              (i.hasDescendantsOf = function (t) {
                this.win.document.activeElement &&
                  this.co(this.win.document.activeElement);
                for (var i = 0; i < this.uo.length; i++)
                  if (t.contains(this.uo[i].el)) return !0;
                return !1;
              }),
              t
            );
          ...
          dh = (function () {
            function t(t) {
              ...
              (this.ampdoc = t),
                (this.win = t.win),
                (this.Qt = or(t)),
                (this.lo = mr(this.ampdoc)),
                (this.vo = dr(this.win)),
                (this.do = new lh(this.win, 6e4)),
                this.do.onFocus(function (t) {
                  i.mo(t);
                });
            }
            var i = t.prototype;
            return (
              ...
              (i.collapseElement = function (t) {
                var i = this.lo.getLayoutRect(t);
                0 != i.width &&
                  0 != i.height &&
                  (Ge(this.win, "dirty-collapse-element")
                    ? this.dirtyElement(t)
                    : this.Qt.setRelayoutTop(i.top)),
                  Hs.forElement(t).completeCollapse(),
                  this.Qt.schedulePass(vh);
              }),
              (i.measureElement = function (t) {
                return this.vo.measurePromise(t);
              }),
              (i.mutateElement = function (t, i, n) {
                return this.bo(t, null, i, n);
              }),
              (i.measureMutateElement = function (t, i, n) {
                return this.bo(t, i, n);
              }),
              (i.yo = function (t) {
              ...
              (i.bo = function (t, i, n) {
                var r = this,
                  e =
                    ...
                    arguments[3],
                  s = function () {
                    var i = r.lo.getLayoutRect(t);
                    return 0 != i.width && 0 != i.height ? i.top : -1;
                  },
                  u = -1;
                return this.vo.runPromise({
                  measure: function () {
                    i && i(), e || (u = s());
                  },
                  mutate: function () {
                    if ((n(), !e)) {
                      ...
                      r.Qt.schedulePass(vh),
                        -1 != u && r.Qt.setRelayoutTop(u),
                        r.vo.measure(function () {
                          var t = s();
                          -1 != t &&
                            t != u &&
                            (r.Qt.setRelayoutTop(t), r.Qt.schedulePass(vh)),
                            r.Qt.maybeHeightChanged();
                        });
                    }
                  },
                });
              ...
              (i.dirtyElement = function (t) {
                ...
                if (t.classList.contains("i-amphtml-element")) {
                  ...
                  this.Qt.setRelayoutTop(n.getLayoutBox().top);
                } else i = !0;
                this.Qt.schedulePass(vh, i);
              }),
              (i.mo = function (t) {
                ...
                if (i) {
                  ...
                  void 0 !== r &&
                    this.po(n, r.height, r.width, r.margins, void 0, !0);
                }
              }),
              (i.po = function (t, i, n, r, e, s, u) {
                var o = this;
                t.hasBeenMeasured() && !r
                  ? this.wo(t, i, n, void 0, e, s, u)
                  : this.vo.measure(function () {
                      t.hasBeenMeasured() || t.measure();
                      var h = r
                        ? { newMargins: r, currentMargins: o.yo(t) }
                        : void 0;
                      o.wo(t, i, n, h, e, s, u);
                    });
              }),
              (i.wo = function (t, i, n, r, e, s, u) {
                ...
                this.Qt.updateOrEnqueueMutateTask(t, {
                  resource: t,
                  newHeight: i,
                  newWidth: n,
                  marginChange: r,
        ...
        var wh = "navigation",
          ...
          Oh = (function () {
            function t(t) {
              var i = this;
              (this.ampdoc = t),
                (this.Ao = t.getRootNode()),
                (this.lo = mr(this.ampdoc)),
                (this.$e = vr(this.ampdoc)),
                (this.uo = ir(this.ampdoc)),
                (this.xo = sr(this.ampdoc.win)),
                (this.Eo = this.xo.isIos() && this.xo.isSafari()),
                (this.Oo = Ni(this.ampdoc.win) && this.$e.isOvertakeHistory()),
                (this.Po =
                  this.Ao != this.ampdoc.getRootNode() ||
                  !!this.ampdoc.getParent()),
                (this.To = "inabox" == Dt(this.ampdoc.win).runtime),
                (this.Io =
                  this.Ao.nodeType == Node.DOCUMENT_NODE
                    ? this.Ao.documentElement
                    : this.Ao),
                (this.Mo = this.So.bind(this)),
                this.Ao.addEventListener(Ah, this.Mo),
                this.Ao.addEventListener(xh, this.Mo),
                (this.ko = !1),
                (function (t) {
                ...
                Promise.all([
                  this.$e.isTrustedViewer(),
                  this.$e.getViewerOrigin(),
                ]).then(function (t) {
                  var n;
                  (i._o = t[0]), (i.Ro = ((n = t[1]), Tt.test(ls(n).origin)));
                }),
                (this.No = null),
                (this.Co = new $s()),
                (this.Do = new $s());
            ...
            return (
              (i.cleanup = function () {
                this.Mo &&
                  (this.Ao.removeEventListener(Ah, this.Mo),
                  this.Ao.removeEventListener(xh, this.Mo));
              }),
              (i.openWindow = function (t, i, n, r) {
                var e = "";
                (!this.xo.isIos() && this.xo.isChrome()) ||
                  r ||
                  (e += "noopener");
                var s = yh(t, i, n, e);
                s && !r && (s.opener = null);
              ...
              (i.navigateToAmpUrl = function (t, i) {
                return (
                  !!this.$e.hasCapability("a2a") &&
                  (this.$e.sendMessage("a2aNavigate", {
                    url: t,
                    requestedBy: i,
                  }),
                  !0)
              ...
              (i.So = function (t) {
                if (!t.defaultPrevented) {
                  ...
                  i &&
                    ...
                    (t.type == Ah
                      ? this.Uo(i, t)
                      : t.type == xh && this.Lo(i, t));
                }
              }),
              (i.Uo = function (t, i) {
                this.Ho(t);
                var n = this.Go(t.href);
                if (!this.Vo(i, t, n) && !this.Fo(i, t, n)) {
                  var r = this.Bo();
                  Mh(n) != Mh(r) && (this.qo(t, i), (n = this.Go(t.href))),
                    this.Wo(i, t, n, r);
                }
              }),
              (i.Lo = function (t, i) {
                this.Ho(t), this.qo(t, i);
              }),
              (i.qo = function (t, i) {
              ...
              (i.Ho = function (t) {
                ...
                this.ko &&
                  ...
                  (i = (function (t, i) {
                    for (
                      var n = yt(vs(zr.getLocation(t).href).search),
                        r = [],
                        e = 0;
                      e < ph.length;
                      e++
                    ...
                    u && (o = gs(o, yt(u)));
                    for (
                      var h = yt(vs(o).search), a = r.length - 1;
                      a >= 0;
                      a--
                    )
              ...
              (i.Fo = function (t, i, n) {
                ...
                var r = oi(i),
                  ...
                  s = n.protocol;
                if ("ftp:" == s)
                  return yh(r, e, "_blank"), t.preventDefault(), !0;
                var u = /^(https?|mailto):$/.test(s);
                return !(
                  !this.Eo ||
                  u ||
                  (yh(r, e, "_top"), t.preventDefault(), 0)
                );
              }),
              (i.Vo = function (t, i, n) {
                return !(
              ...
              (i.$o = function (t, i, n) {
                var r = this;
                if ((t.preventDefault(), !this.Po)) {
                  var e = i.hash.slice(1),
                    s = null;
                  if (e) {
                    var u = vi(e);
                    s =
                      this.Ao.getElementById(e) ||
                      this.Ao.querySelector('a[name="'.concat(u, '"]'));
                  }
                  i.hash != n.hash
                    ? this.uo.replaceStateForTarget(i.hash).then(function () {
                        r.Yo(s, e);
                      })
                    : this.Yo(s, e);
                }
              ...
              (i.Yo = function (t, i) {
                var n = this;
                t
                  ? (this.lo.scrollIntoView(t),
                    ar(this.ampdoc.win).delay(function () {
                      return n.lo.scrollIntoView(t);
                    }, 1))
                  : Qt().warn(
                      wh,
              ...
              (i.Go = function (t) {
                return lr(this.Io).parse(t);
              }),
              (i.Bo = function () {
                return this.Go("");
              }),
              (i.viewerInterceptsNavigation = function (t, i) {
                var n = this.$e.hasCapability("interceptNavigation"),
                  r =
        ...
        function Ih(t, i) {
          ...
          if (n && n.href) {
            ...
            if (r) {
              ...
              s != r &&
                (n.getAttribute(Ph) || n.setAttribute(Ph, r),
        ...
        var Sh = (function () {
            ...
            return (
              ...
              (i.schedulePreload = function (t, i) {
                this.Jo(this.Qt.getResourceForElement(t), !1, Th(i));
              }),
              (i.scheduleLayout = function (t, i) {
                this.Jo(this.Qt.getResourceForElement(t), !0, Th(i));
              }),
              (i.schedulePause = function (t, i) {
                var n = this.Qt.getResourceForElement(t);
                (i = Th(i)),
                  this.Xo(n, i, function (t) {
                    t.pause();
                  });
              }),
              ...
              (i.Xo = function (t, i, n) {
                for (var r, e = o(i, !0); !(r = e()).done; ) {
                  var s = r.value;
                  Zt(t.element.contains(s)), this.Qo(s, n);
                }
              }),
              (i.Qo = function (t, i) {
                if (t.classList.contains("i-amphtml-element")) {
                  i(this.Qt.getResourceForElement(t));
                  ...
                  for (
                    ...
                    o || (e.push(u), i(this.Qt.getResourceForElement(u)));
                  }
              }),
              (i.Jo = function (t, i, n) {
                this.Xo(t, n, function (i) {
          ...
          Rh = (function () {
            function t(t) {
              (this.Zo = t.navigator), (this.t = t);
            }
            var i = t.prototype;
            return (
              (i.isAndroid = function () {
                return /Android/i.test(this.Zo.userAgent);
              }),
              (i.isIos = function () {
                return /iPhone|iPad|iPod/i.test(this.Zo.userAgent);
              }),
              (i.isSafari = function () {
                return (
                  /Safari/i.test(this.Zo.userAgent) &&
                  !this.isChrome() &&
                  !this.isEdge() &&
                  !this.isFirefox() &&
                  !this.isOpera()
              ...
              (i.isChrome = function () {
                return (
                  /Chrome|CriOS/i.test(this.Zo.userAgent) &&
                  !this.isEdge() &&
                  !this.isOpera()
                );
              }),
              (i.isFirefox = function () {
                return (
                  /Firefox|FxiOS/i.test(this.Zo.userAgent) && !this.isEdge()
                );
              }),
              (i.isOpera = function () {
                return /OPR\/|Opera|OPiOS/i.test(this.Zo.userAgent);
              }),
              (i.isEdge = function () {
                return /Edge/i.test(this.Zo.userAgent);
              }),
              (i.isWebKit = function () {
                return /WebKit/i.test(this.Zo.userAgent) && !this.isEdge();
              }),
              (i.isWindows = function () {
                return /Windows/i.test(this.Zo.userAgent);
              }),
              (i.isStandalone = function () {
                return (
                  (this.isIos() && this.Zo.standalone) ||
                  (this.isChrome() &&
                    this.t.matchMedia("(display-mode: standalone)").matches)
                );
              }),
              (i.isBot = function () {
                return /bot/i.test(this.Zo.userAgent);
              }),
              (i.getMajorVersion = function () {
                return this.isSafari()
                  ? this.isIos()
                    ? this.getIosMajorVersion() || 0
                    : this.tu(/\sVersion\/(\d+)/, 1)
                  : this.isChrome()
                    ? this.tu(/(Chrome|CriOS)\/(\d+)/, 2)
                    : this.isFirefox()
                      ? this.tu(/(Firefox|FxiOS)\/(\d+)/, 2)
                      : this.isOpera()
                        ? this.tu(/(OPR|Opera|OPiOS)\/(\d+)/, 2)
                        : this.isEdge()
                          ? this.tu(/Edge\/(\d+)/, 1)
                          : 0;
              }),
              (i.tu = function (t, i) {
                if (!this.Zo.userAgent) return 0;
                var n = this.Zo.userAgent.match(t);
        ...
        var kh = (function () {
          ...
          Ch = (function () {
            function t() {
              (this.qi = []), (this.ru = {}), (this.eu = 0), (this.su = 0);
            }
            var i = t.prototype;
            return (
              (i.getSize = function () {
              ...
              (i.dequeue = function (t) {
                var i = this.ru[t.id];
                return (
                  !!this.removeAtIndex(t, this.qi.indexOf(i)) &&
                  ((this.su = Date.now()), !0)
                );
              }),
              (i.peek = function (t) {
              ...
              (i.removeAtIndex = function (t, i) {
                ...
                return !(
                  !n ||
                  this.qi[i] != n ||
                  (this.qi.splice(i, 1), delete this.ru[t.id], 0)
                );
              }),
              (i.purge = function (t) {
                for (var i = this.qi.length; i--; )
                  t(this.qi[i]) && this.removeAtIndex(this.qi[i], i);
              }),
              t
            );
          })(),
          ...
          Dh = (function () {
            function t(t) {
              ...
              (this.ampdoc = t),
                ...
                (this.yu = 0),
                (this.wu = 0),
                (this.Pe = new Cu(this.win, function () {
                  return i.doPass();
                })),
                (this.Au = new Cu(this.win, function () {
                  (i.bu = !0), i.schedulePass();
                })),
                (this.xu = new Ch()),
                (this.Ni = new Ch()),
                (this.Eu = this.Ou.bind(this)),
                (this.Pu = []),
                (this.Tu = []),
                (this.Iu = !1),
                (this.lo = mr(this.ampdoc)),
                ...
                (this.Ru = []),
                (this.Nu = new a()),
                (this.Cu = new kh(this.ampdoc.getVisibilityState())),
                this.lo.onChanged(function (t) {
                  (i.yu = i.win.Date.now()),
                    (i.wu = t.velocity),
                    t.relayoutAll && ((i.bu = !0), (i.ku = !0)),
                    i.schedulePass();
                }),
                this.lo.onScroll(function () {
                  i.yu = i.win.Date.now();
                }),
                ...
                this.$e.onRuntimeState(function (t) {
                  Qt().fine(Nh, "Runtime state:", t),
                    (i.ou = t),
                    i.schedulePass(1);
                }),
                Xs(this.ampdoc, function () {
                  i.Du(i.Cu), i.schedulePass(0);
                }),
                this.ju(),
                (this.zu = dt(
                  this.win,
                ...
                Ye(this.win.document, "scroll", this.zu, {
                  capture: !0,
                  passive: !0,
                });
            }
            ...
            return (
              ...
              (i.getScrollDirection = function () {
                return Math.sign(this.wu) || 1;
              }),
              (i.add = function (t) {
                this.au++, 1 == this.au && this.lo.ensureReadyForElements();
                var i = Hs.forElementOptional(t);
                i && 0 != i.getState() && !t.reconstructWhenReparented()
                  ? (i.requestMeasure(),
                    Qt().fine(Nh, "resource reused:", i.debugid))
                  : ((i = new Hs(++this.hu, t, this)),
                    Qt().fine(Nh, "resource added:", i.debugid)),
                  this.Qt.push(i),
                  this.Au.schedule(1e3);
              }),
              (i.Hu = function () {
                return (
                  this.cu < 20 ||
              ...
              (i.Fu = function () {
                for (var t = 0; t < this.Tu.length; t++) {
                  var i = this.Tu[t];
                  (this.vu || ki(i.element, this.ampdoc.getRootNode())) &&
                    (this.Tu.splice(t--, 1), this.Vu(i));
                }
              }),
              (i.Vu = function (t) {
                var i = this,
                  n =
                    ...
                    void 0 !== arguments[1] &&
                    arguments[1];
                if (!n && !this.Hu() && !t.isBuildRenderBlocking()) return null;
                var r = t.build();
                return r
              ...
              (i.Bu = function (t) {
                var i = this.Qt.indexOf(t);
                -1 != i && this.Qt.splice(i, 1),
              ...
              (i.upgraded = function (t) {
                ...
                this.Gu(i), Qt().fine(Nh, "resource upgraded:", i.debugid);
              }),
              (i.updateLayoutPriority = function (t, i) {
                var n = Hs.forElement(t);
                n.updateLayoutPriority(i),
                  this.Ni.forEach(function (t) {
                    t.resource == n && (t.priority = i);
                  }),
                  this.schedulePass();
              }),
              (i.schedulePass = function (t) {
                return this.Pe.schedule(t);
              }),
              (i.updateOrEnqueueMutateTask = function (t, i) {
                for (var n = null, r = 0; r < this.Pu.length; r++)
                  if (this.Pu[r].resource == t) {
                    n = this.Pu[r];
                    break;
                  }
                n
                ...
                if (this.ou) {
                  if (
                    ...
                    this.$e.sendMessage(
                      ...
                      (this.Su = this.lo.getContentHeight()),
                      this.$e.sendMessage(
                        "documentHeight",
                        { height: this.Su },
                        !0,
                      ),
                      Qt().fine(Nh, "document height on load: %s", this.Su);
                  }
                  !this.du &&
                    this.Wu &&
                    this.Qt.every(function (t) {
                      return t.getState() != Hs.NOT_BUILT || t.element.R1();
                    }) &&
                    ((this.Wu = !1), (this.ku = !0));
                  var e = this.lo.getSize();
                  Qt().fine(
                    Nh,
                    "PASS: visible=",
                    this.lu,
                    ...
                    this.Pe.cancel(),
                    (this.Mu = !1),
                    this.Cu.setState(this.ampdoc.getVisibilityState()),
                    this.$u(),
                    this.ku &&
                      ((this.ku = !1),
                      this.vo.measure(function () {
                        var i = t.lo.getContentHeight();
                        i != t.Su &&
                          (t.$e.sendMessage(
                            "documentHeight",
                            { height: i },
                          ...
                          (t.Su = i),
                          Qt().fine(Nh, "document height changed: %s", t.Su),
                          t.lo.contentHeightChanged());
                      }));
                  for (var s = 0; s < this._u.length; s++) (0, this._u[s])();
                  this._u.length = 0;
              ...
              (i.Yu = function () {
                var t = this,
                  ...
                  e = n.height / 10,
                  s =
                    (Math.abs(this.wu) < 0.01 && i - this.yu > 500) ||
                    i - this.yu > 1e3;
                if (this.Pu.length > 0) {
                  Qt().fine(Nh, "change size requests:", this.Pu.length);
                  var u = this.Pu;
                  this.Pu = [];
                  for (
                    var o = -1,
                      ...
                      c = function (i) {
                        ...
                        else if (c.force || !t.lu) O = !0;
                        else if (
                          t.do.hasDescendantsOf(v.element) ||
                          (l &&
                            l.userActivation &&
                  ...
                  -1 != o && this.setRelayoutTop(o),
                    h.length > 0 &&
                      this.vo.run(
                        {
                          measure: function (i) {
                            (i.scrollHeight = t.lo.getScrollHeight()),
                              (i.scrollTop = t.lo.getScrollTop());
                          },
                          mutate: function (i) {
                            var n = -1;
              ...
              (i.Ju = function (t, i, n) {
                var r = this.lo.getContentHeight(),
              ...
              (i.Zu = function () {
                var t = this.win.Date.now(),
                  ...
                  r = this.gu;
                (this.bu = !1), (this.gu = -1);
                for (var e, s = 0, u = 0, o = 0; o < this.Qt.length; o++) {
                  var h = this.Qt[o];
                  0 != h.getState() ||
                    h.isBuilding() ||
                    h.element.R1() ||
                ...
                if (s > 0 || u > 0 || n || -1 != r || i.length > 0)
                  for (var a = 0; a < this.Qt.length; a++) {
                    ...
                    if (
                      ...
                      f && (this.Xu(c) || (e || (e = []), e.push(c)));
                    }
                  }
                (i.length = 0), e && this.Qu(e);
                var v,
                  d = this.lo.getRect();
                v = this.lu ? Hi(d, 0.25, 2) : d;
                for (
                  var m = this.lu ? Hi(d, 0.25, 0.25) : d, p = 0;
                  p < this.Qt.length;
                  p++
                ) {
                  var g = this.Qt[p];
                  if (0 != g.getState() && !g.hasOwner() && !g.element.R1()) {
                    var b = this.lu && g.isDisplayed() && g.overlaps(m);
                    g.setInViewport(b);
                  }
                }
                if (v)
                  for (var y = 0; y < this.Qt.length; y++) {
                    var w = this.Qt[y];
                    w.isBuilt() ||
                      w.isBuilding() ||
                      w.hasOwner() ||
                ...
                if (this.lu && this.th(t)) {
                  for (var A = 0, x = 0; x < this.Qt.length && A < 4; x++) {
                    var E = this.Qt[x];
                    2 == E.getState() &&
                      !E.hasOwner() &&
                      !E.element.R1() &&
                  ...
                  for (var P = 0; P < this.Qt.length && A < 4; P++) {
                    var O = this.Qt[P];
                    2 != O.getState() ||
                      O.hasOwner() ||
                      O.element.R1() ||
              ...
              (i.ih = function () {
                for (
                  ...
                  this.Ni.dequeue(n);
                  var r = this.xu.getTaskById(n.id);
                  if (r) {
                    var e = this.rh.bind(this, n);
                    r.promise.then(e, e);
                  } else {
                    var s = n.resource;
                    s.measure(),
                      this.eh(s, n.forceOutsideViewport)
                        ? ((n.promise = n.callback()),
                          ...
                          n.promise
                            .then(
                              this.sh.bind(this, n, !0),
                              this.sh.bind(this, n, !1),
                            )
                            .catch(Ds))
                        : (Qt().fine(Nh, "cancelled", n.id),
                          s.layoutCanceled());
                  }
                  (n = this.Ni.peek(this.Eu)), (i = -1);
                }
                if (
                  (Qt().fine(
                    Nh,
                  ...
                  return i;
                var u = 2 * (t - this.xu.getLastDequeueTime());
                return Math.max(Math.min(3e4, u), 5e3);
              }),
              (i.Ou = function (t) {
                var i = this.lo.getRect(),
              ...
              (i.nh = function (t) {
                ...
                if (0 == this.xu.getSize()) {
                  if (-1 === this.pu) return 0;
                  var n = 1e3 * t.priority;
                  return Math.max(n - (i - this.pu), 0);
                }
                var r = 0;
                return (
                  this.xu.forEach(function (n) {
              ...
              (i.rh = function (t) {
                this.Ni.getTaskById(t.id) || this.Ni.enqueue(t);
              }),
              (i.sh = function (t, i, n) {
                if ((this.xu.dequeue(t), this.schedulePass(1e3), !i))
                  return (
                    Qt().info(Nh, "task failed:", t.id, t.resource.debugid, n),
                    Promise.reject(n)
                  );
              }),
              (i.eh = function (t, i) {
              ...
              (i.scheduleLayoutOrPreload = function (t, i, n, r) {
                if (!t.element.R1()) {
                  ...
                  this.eh(t, u) &&
                    (i
                      ? this.Xi(t, "L", 0, n || 0, u, t.startLayout.bind(t))
                      : this.Xi(t, "P", 2, n || 0, u, t.startLayout.bind(t)));
                }
              }),
              (i.Xi = function (t, i, n, r, e, s) {
                var u = t.getTaskId(i),
                  o = {
                    id: u,
                    resource: t,
              ...
              (i.qu = function (t, i) {
                if (
                  ((1 != t.getState() && 2 != t.getState()) ||
                    (this.Ni.purge(function (i) {
                      return i.resource == t;
                    }),
                    this.xu.purge(function (i) {
                      return i.resource == t;
                    }),
                    q(this.Pu, function (i) {
                      return i.resource === t;
                    })),
              ...
              (i.Uu = function (t) {
                ...
                if (
                  ...
                  i !== this.lo.getScrollingElement()
                ) {
                  var n = i;
                  this.Ru.includes(n) ||
                    (this.Ru.push(n), this.schedulePass(70));
                }
              }),
              t
            );
        ...
        var Lh = "STANDARD-ACTIONS",
          ...
          Hh = (function () {
            function t(t) {
              this.ampdoc = t;
              var i = t.getHeadNode();
              (this.uh = rr(t)), (this.lo = mr(t)), this.hh(Bn(i)), this.ah();
            }
            var i = t.prototype;
            return (
              (i.hh = function (t) {
                t.addGlobalTarget("AMP", this.fh.bind(this)),
                  t.addGlobalMethodHandler("hide", this.lh.bind(this)),
                  t.addGlobalMethodHandler("show", this.dh.bind(this)),
                  t.addGlobalMethodHandler(
                    "toggleVisibility",
                    this.mh.bind(this),
                  ),
                  t.addGlobalMethodHandler("scrollTo", this.ph.bind(this)),
                  t.addGlobalMethodHandler("focus", this.bh.bind(this)),
                  t.addGlobalMethodHandler("toggleClass", this.gh.bind(this)),
                  t.addGlobalMethodHandler("copy", this.yh.bind(this)),
                  t.addGlobalMethodHandler("toggleChecked", this.wh.bind(this));
              }),
              (i.ah = function () {
                this.Ah() &&
              ...
              (i.fh = function (t) {
                ...
                switch (n) {
                  ...
                  case "goBack":
                    return (
                      ir(this.ampdoc).goBack(!(!i || !0 !== i.navigate)), null
                    );
                  case "print":
                    return e.print(), null;
                  case "copy":
              ...
              (i.xh = function (t) {
                ...
                return (
                  ...
                  u.then(
                    function () {
                      var t;
                      ((t = i.ampdoc), Pn(t, "navigation")).navigateTo(
                        s,
                        n.url,
                        "AMP.".concat(e),
              ...
              (i.ph = function (t) {
                ...
                return (
                  ...
                  J(e) || (e = void 0),
                  this.lo.animateScrollIntoView(i, r, e)
                );
              }),
              (i.bh = function (t) {
              ...
              (i.lh = function (t) {
                ...
                if (i.classList.contains("i-amphtml-element")) {
                  ...
                  this.uh.mutateElement(i, function () {
                    return kr(i, !1);
                  });
                return null;
              }),
              (i.dh = function (t) {
                ...
                this.uh.measureElement(function () {
                  "none" != Nr(r, n).display ||
                    Uh(n) ||
                    Jt().warn(
                      Lh,
                ...
                return (
                  s && sr(r).isIos()
                    ? (this.Ph(n, s), this.uh.mutateElement(n, function () {}))
                    : this.uh.mutateElement(n, function () {
                        i.Ph(n, s);
                      }),
                  null
                );
              ...
              (i.mh = function (t) {
                return Uh(t.node) ? this.dh(t) : this.lh(t);
              }),
              (i.gh = function (t) {
                var i = t.node,
                  n = t.args,
          ...
          Vh = (function () {
            ...
            return (
              ...
              (i.get = function (t, i) {
                return this.kh().then(function (n) {
                  return n.get(t, i);
                });
              }),
              ...
              (i.setNonBoolean = function (t, i, n) {
                return this._h(function (r) {
                  return r.set(t, i, n);
                });
              }),
              (i.remove = function (t) {
                return this._h(function (i) {
                  return i.remove(t);
                });
              }),
              ...
              (i.kh = function () {
                return (
                  this.Ih ||
                    (this.Ih = this.Es.loadBlob(this.i)
                      .then(function (t) {
                        return t ? at(atob(t)) : {};
                      })
                      .catch(function (t) {
                        return (
                          Qt().expectedError(Gh, "Failed to load store: ", t),
                          {}
                        );
                      })
                      .then(function (t) {
              ...
              (i._h = function (t) {
                ...
                return this.kh()
                  .then(function (n) {
                    ...
                    return i.Es.saveBlob(i.i, r);
                  })
                  .then(this.Rh.bind(this));
              }),
              (i.Sh = function () {
                var t = this;
                this.$e.onBroadcast(function (i) {
                  "amp-storage-reset" == i.type &&
                    i.origin == t.i &&
                    (Qt().fine(Gh, "Received reset message"), (t.Ih = null));
                });
              }),
              (i.Rh = function () {
          ...
          Fh = (function () {
            function t(t, i) {
              (this.obj = E(t)),
                (this.Nh = i || 8),
                (this.Ch = this.obj.vv || Object.create(null)),
                this.obj.vv || (this.obj.vv = this.Ch);
            }
            var i = t.prototype;
            return (
              (i.get = function (t, i) {
              ...
              (i.set = function (t, i, n) {
                if (
                  ...
                  var r = this.Ch[t],
                    e = Date.now();
                  n && (e = r.t), (r.v = i), (r.t = e);
                } else this.Ch[t] = { v: i, t: Date.now() };
                var s = Object.keys(this.Ch);
                if (s.length > this.Nh) {
          ...
          qh = (function () {
            function t(t) {
              if (((this.win = t), (this.Dh = this.jh()), !this.Dh)) {
            ...
            return (
              ...
              (i.loadBlob = function (t) {
                ...
                return new Promise(function (n) {
                  i.Dh ? n(i.win.localStorage.getItem(i.zh(t))) : n(null);
                });
              }),
              (i.saveBlob = function (t, i) {
                var n = this;
                return new Promise(function (r) {
                  n.Dh ? (n.win.localStorage.setItem(n.zh(t), i), r()) : r();
                });
              }),
              t
            );
          ...
          Yh = (function () {
            function t(t) {
              (this.wi = t), (this.Uh = {}), (this.Lh = {});
            }
            var i = t.prototype;
            return (
              (i.whenReady = function (t) {
                return this.Hh(t).then(Wh);
              }),
              (i.setHtmlForTemplate = function (t, i) {
                var n = this;
                return this.Hh(t).then(function (t) {
                  return n.Gh(t, i);
                });
              }),
              ...
              (i.Hh = function (t) {
                ...
                return (
                  s ||
                  ((s = this.Fh(t, r).then(function (n) {
                    var r = n,
                      e = (t[$h] = new r(t, i.wi.win));
              ...
              (i.Fh = function (t, i) {
                if (this.Uh[i]) return this.Uh[i];
                var n = new a(),
                  r = n.promise,
                  e = n.resolve;
                return (this.Uh[i] = r), (this.Lh[i] = e), r;
              }),
              (i.Bh = function (t, i) {
                if (this.Uh[t]) {
                  var n = this.Lh[t];
                  ti(n, "Duplicate template type: %s", t),
                    delete this.Lh[t],
                    n(i);
                } else this.Uh[t] = Promise.resolve(i);
              }),
              (i.Vh = function (t, i) {
                return t.render(i);
              }),
          ...
          Kh = (function () {
            function t(t) {
              (this.win = t),
                (this.qh = this.win.Promise.resolve()),
                (this.Wh = 0),
                (this.$h = {}),
                (this.Kh = Date.now());
            }
        ...
        var Xh = (function () {
            function t(t) {
              var i = t.getRootNode(),
                n = i.ownerDocument || i;
              (this.Yh = n.createElement("a")), (this.yr = new as(100));
            }
            var i = t.prototype;
            return (
              (i.parse = function (t, i) {
                return ds(this.Yh, t, i ? null : this.yr);
              }),
              (i.Jh = function (t) {
              ...
              (i.getWinOrigin = function (t) {
                return t.origin || this.Jh(t.location.href).origin;
              }),
          ...
          Zh = (function () {
            ...
            return (
              (i.expand = function (t) {
                if (!t.length) return this.ta ? t : Promise.resolve(t);
                var i = this.Xh.getExpr(this.Qh, this.Me),
                  n = this.na(t, i);
                return n.length
                  ? this.ra(t, n)
                  : this.ta
                  ...
                  for (
                    ...
                    if (u && e === u.start)
                      ...
                      if (o && ")" === t[e] && !h) {
                        e++, o--;
                        var b = r.pop();
                        return g && v.push(g), m.push(v), n.ea(b, m);
                      }
                      (l += t[e]), e++;
                    }
              ...
              (i.ea = function (t, i) {
                ...
                return this.oa(n, e, i).then(function (t) {
              ...
              (i.oa = function (t, i, n) {
                ...
                try {
                  ...
                  return r
                    .then(function (t) {
                      return e.ha(i, t, n), null == t ? "" : t;
                    })
                    .catch(function (t) {
                      return d(t), e.ha(i, "", n), Promise.resolve("");
                    });
                } catch (t) {
                  return d(t), this.ha(i, "", n), Promise.resolve("");
                }
              }),
              (i.ua = function (t) {
                return Promise.all(
              ...
              (i.sa = function (t, i, n) {
                try {
                  var r,
                    e = t;
                  return (
                    "function" == typeof t && (e = t.apply(null, this.aa(n))),
                    e && "function" == typeof e.then
                      ? (Jt().error(Qh, "ignoring async macro resolution"),
                        (r = ""))
                      : "string" == typeof e ||
                          "number" == typeof e ||
                          "boolean" == typeof e
                        ? (this.ha(i, e, n), (r = e.toString()))
                        : (this.ha(i, "", n), (r = "")),
                    r
                  );
                } catch (t) {
                  return d(t), this.ha(i, "", n), "";
                }
              }),
              (i.aa = function (t) {
                return t
        ...
        var ha = (function (t) {
            ...
            function n(t) {
              var n;
              return ((n = i.call(this, t)).ca = null), (n.fa = {}), n;
            }
            var r = n.prototype;
            return (
              (r.la = function (t, i, n) {
              ...
              (r.initialize = function () {
                ...
                this.set("COUNTER", function (t) {
                  ...
                  this.set("CANONICAL_URL", function () {
                    return t.va().canonicalUrl;
                  }),
                  this.set("CANONICAL_HOST", function () {
                    return vs(t.va().canonicalUrl).host;
                  }),
                  this.set("CANONICAL_HOSTNAME", function () {
                    return vs(t.va().canonicalUrl).hostname;
                  }),
                  this.set("CANONICAL_PATH", function () {
                    return vs(t.va().canonicalUrl).pathname;
                  }),
                  ...
                  this.setAsync("EXTERNAL_REFERRER", function () {
                    return vr(t.ampdoc)
                      ...
                      .then(function (t) {
                        return t
                          ? vs(Is(t)).hostname === zr.getHostname(i)
                            ? null
                            : t
                          : null;
                      });
                  ...
                  this.set("AMPDOC_URL", function () {
                    return As(t.da(i.location.href));
                  }),
                ...
                this.setBoth(
                  ...
                  this.set("SOURCE_HOST", function () {
                    return vs(t.va().sourceUrl).host;
                  }),
                  this.set("SOURCE_HOSTNAME", function () {
                    return vs(t.va().sourceUrl).hostname;
                  }),
                  this.set("SOURCE_PATH", function () {
                    return vs(t.va().sourceUrl).pathname;
                  }),
                  this.set("PAGE_VIEW_ID", function () {
                    return t.va().pageViewId;
                  }),
                  this.setAsync("PAGE_VIEW_ID_64", function () {
                    return t.va().pageViewId64;
                  }),
                  this.setBoth(
                    "QUERY_PARAM",
                    function (i) {
                ...
                this.set("SCREEN_WIDTH", ua(o, "width")),
                  ...
                  this.setBoth(
                    ...
                    function (i) {
                      var n;
                      return null !== (n = t.fa[i]) && void 0 !== n ? n : "";
                    },
                    function (n) {
                      return t.ya(n, i);
                    },
                  ...
                  this.la("TCP_CONNECT_TIME", "connectStart", "connectEnd"),
                  this.la(
                    "SERVER_RESPONSE_TIME",
                    "requestStart",
                    "responseStart",
                  ),
                  this.la("PAGE_DOWNLOAD_TIME", "responseStart", "responseEnd"),
                  this.la("REDIRECT_TIME", "navigationStart", "fetchStart"),
                  this.la(
              ...
              (r.da = function (t) {
                var i = this.va().replaceParams;
                return i
                  ? (function (t, i) {
                      for (
                        var n = yt(vs(t).search),
                          r = {},
                          e = Object.keys(i),
                          s = 0;
                        s < e.length;
            ...
            (function () {
              ...
              return (
                (i.ae = function () {
                  this.initialize(), (this.xa = !0);
                }),
                (i.initialize = function () {}),
                (i.get = function (t) {
                  return this.xa || this.ae(), this.Aa[t];
                }),
                (i.set = function (t, i) {
                  return (
                ...
                (i.getExpr = function (t, i) {
                  this.xa || this.ae();
                  var n = D(D({}, this.Aa), t);
                  return this.Oa(Object.keys(n), i);
                }),
                (i.Oa = function (t, i) {
                  var n = this;
                  if (
          ...
          aa = (function () {
            function t(t, i) {
              (this.ampdoc = t), (this.Xh = i);
            }
            var i = t.prototype;
            return (
              (i.expandStringSync = function (t, i, n) {
                return new Zh(this.Xh, i, void 0, !0, n, !0).expand(t);
              }),
              (i.expandStringAsync = function (t, i, n) {
                return new Zh(this.Xh, i, void 0, void 0, n, !0).expand(t);
              }),
              (i.expandUrlSync = function (t, i, n) {
                return this.Ta(t, new Zh(this.Xh, i, void 0, !0, n).expand(t));
              }),
              (i.expandUrlAsync = function (t, i, n, r) {
                var e = this;
                return new Zh(this.Xh, i, void 0, void 0, n, r)
                  .expand(t)
                  .then(function (i) {
                    return e.Ta(t, i);
                  });
              ...
              (i.Ia = function (t, i) {
                ...
                var r = new Zh(this.Xh, void 0, void 0, i, n).expand(
                  t["amp-original-value"] || t.value,
                );
                return i
                  ? (t.value = r)
              ...
              (i.mn = function (t) {
                ...
                if (
                  t.origin == vs(i.canonicalUrl).origin ||
                  t.origin == vs(i.sourceUrl).origin
                )
                  return !0;
              ...
              (i.collectVars = function (t, i) {
                ...
                return new Zh(this.Xh, i, n).expand(t).then(function () {
                  return n;
                });
              }),
              (i.collectDisallowedVarsSync = function (t) {
                var i = t.getAttribute("src"),
                  n = new Zh(this.Xh).getMacroNames(i),
                  r = this.Ma(t);
                return r
                  ? n.filter(function (t) {
                      return !r[t];
              ...
              (i.Ta = function (t, i) {
                return vs(i, !0).protocol != vs(t, !0).protocol
                  ? (Jt().error(ea, "Illegal replacement of the protocol: ", t),
                    t)
                  : (ti(
                      Es(i),
          ...
          la = (function () {
            function t(t) {
              ...
              (this.ampdoc = t),
                ...
                (this.La = A()),
                t.isSingleDoc() &&
                  Object.assign(this.La, yt(this.win.location.hash)),
                (this.ou = !parseInt(t.getParam("off"), 10)),
                Qt().fine(ca, "- runtimeOn:", this.ou),
                (this.ka = !(!parseInt(t.getParam("history"), 10) && !this.ka)),
                Qt().fine(ca, "- history:", this.ka),
                Qt().fine(
                  ca,
                  "- visibilityState:",
              ...
              if (
                ...
                (this.Ya = As(this.win.location.href || "")),
                (this.Ja = new Promise(function (n) {
            ...
            return (
              ...
              (i.isWebviewEmbedded = function () {
                return !this.Oo && "1" == this.ampdoc.getParam("webview");
              }),
              (i.isCctEmbedded = function () {
                if (null != this.Ha) return this.Ha;
                if (((this.Ha = !1), !this.Oo)) {
              ...
              (i.maybeUpdateFragmentForCct = function () {
                if (this.isCctEmbedded() && this.win.history.replaceState) {
                  ...
                  this.Qa(t, n) &&
                    ((this.La.ampshare = i),
                    this.win.history.replaceState({}, "", "#" + bs(this.La)));
                }
              }),
              (i.Qa = function (t, i) {
                var n = function (t) {
              ...
              (i.toggleRuntime = function () {
                (this.ou = !this.ou),
                  Qt().fine(ca, "Runtime state:", this.ou),
                  this.Na.fire(this.ou);
              }),
              (i.onRuntimeState = function (t) {
                return this.Na.add(t);
              }),
              ...
              (i.Za = function (t) {
                ...
                t &&
                  ...
                  t === wr &&
                    (t = null != this.ampdoc.getLastVisibleTime() ? xr : gr),
                ...
                return (
                  ...
                  this.isCctEmbedded()
                    ...
                    : this.win.location.ancestorOrigins.length > 0 &&
                      this.tc(this.win.location.ancestorOrigins[0]))
                );
              }),
              ...
              (i.onMessage = function (t, i) {
                var n = this._a[t];
                n || ((n = new Er()), (this._a[t] = n));
                var r = n.add(i);
                return (
                  this.Ua[t] &&
                    (this.Ua[t].forEach(function (t) {
              ...
              (i.onMessageRespond = function (t, i) {
                ...
                return (
                  ...
                  this.Ua[t] &&
                    ...
                    (this.Ua[t] = [])),
                  function () {
                    n.Ra[t] === i && delete n.Ra[t];
                  }
                );
              }),
              (i.receiveMessage = function (t, i, n) {
                if ("visibilitychange" == t) return this.Za(i.state), h();
                if ("broadcast" == t) return this.Ca.fire(i), h();
                var r = this._a[t],
                  e = this.Ra[t];
                if (!r && !e) {
                  if (
                    ((this.Ua[t] = this.Ua[t] || []), this.Ua[t].length >= 50)
                  )
                    return;
                  var s = new a();
                  return this.Ua[t].push({ data: i, deferred: s }), s.promise;
                }
              ...
              (i.setMessageDeliverer = function (t, i) {
                ...
                if (
                  ...
                  var r = this.za.slice(0);
                  (this.za = []),
                    r.forEach(function (t) {
                      var i = n.Da(t.eventType, t.data, t.awaitResponse);
              ...
              (i.sendMessageAwaitResponse = function (t, i) {
                var n =
                  ...
                  void 0 !== arguments[2] &&
                  arguments[2];
                return this.ic(t, i, n, !0);
              }),
              (i.ic = function (t, i, n, r) {
                var e = this;
                if (this.Da)
                  return c(function () {
                    return e.Da(t, i, r);
                  });
                if (!this.Fa) return r ? Promise.reject(va()) : h();
                if (!n)
                  return this.Fa.then(function () {
                    return e.Da(t, i, r);
                  });
                var s,
                  u = B(this.za, function (i) {
                    return i.eventType == t;
                  });
                if (-1 != u)
                  ((s = this.za.splice(u, 1)[0]).data = i),
                ...
                return this.za.push(s), s.responsePromise;
              }),
              (i.broadcast = function (t) {
                return this.Fa
                  ? this.ic("broadcast", t, !1, !1).then(
                      function () {
                        return !0;
                      },
                      function () {
        ...
        var pa = (function () {
            ...
            return (
              (t.solveYValueFromXValue = function (i, n, r, e, s, u, o, h, a) {
                return t.nc(t.rc(i, n, e, u, h), r, s, o, a);
              }),
              (t.rc = function (i, n, r, e, s) {
                var u = 1e-6,
                  o = (i - n) / (s - n);
                if (o <= 0) return 0;
                if (o >= 1) return 1;
              ...
              (t.ec = function (i, n, r, e, s) {
                if (0 == i) return n;
                if (1 == i) return s;
                var u = t.sc(n, r, i),
                  o = t.sc(r, e, i),
                  h = t.sc(e, s, i);
                return (u = t.sc(u, o, i)), (o = t.sc(o, h, i)), t.sc(u, o, i);
              }),
              (t.nc = function (i, n, r, e, s) {
                if (0 == i) return n;
                if (1 == i) return s;
                var u = t.sc(n, r, i),
                  o = t.sc(r, e, i),
          ...
          ga = {
            ...
            EASE: function (t) {
              return pa.solveYValueFromXValue(
                t,
                0,
                0,
                0.25,
        ...
        var wa = "Animation",
          ...
          xa = (function () {
            ...
            return (
              ...
              (i.start = function (t) {
                return new Ea(this.vo, this.oc, this.hc, this.uc, t);
              }),
              t
            );
          })(),
          Ea = (function () {
            function t(t, i, n, r, e) {
              ...
              (this.cc = o.promise),
                (this.Jt = o.resolve),
                (this.fc = o.reject),
                (this.lc = this.vo.createAnimTask(this.oc, {
                  mutate: this.vc.bind(this),
                })),
                this.vo.canAnimate(this.oc)
                  ? this.lc(this.ni)
                  : (Qt().warn(wa, "cannot animate"), this.dc(!1, 0));
            }
            var i = t.prototype;
            return (
              (i.then = function (t, i) {
                return t || i ? this.cc.then(t, i) : this.cc;
              }),
              ...
              (i.dc = function (t, i) {
                if (this.Ee) {
                  if (((this.Ee = !1), 0 != i)) {
                    this.hc.length > 1 &&
                      this.hc.sort(function (t, i) {
                        return t.delay + t.duration - (i.delay + i.duration);
                      });
                    try {
                      if (i > 0)
                        for (var n = 0; n < this.hc.length; n++)
                          this.hc[n].func(1, !0);
                      else
                        for (var r = this.hc.length - 1; r >= 0; r--)
                          this.hc[r].func(0, !1);
                    } catch (i) {
              ...
              (i.vc = function (t) {
                if (this.Ee) {
                  for (
                    var i = Date.now(),
                      n = Math.min((i - this.Kh) / this.ac, 1),
                      r = 0;
                    r < this.hc.length;
                    r++
                  ) {
                  ...
                  for (var s = 0; s < this.hc.length; s++) {
                    var u = this.hc[s];
                    u.started && !u.completed && this.mc(u, n);
                  }
                  1 == n
                    ? this.dc(!0, 0)
                    : this.vo.canAnimate(this.oc)
                      ? this.lc(this.ni)
                      : (Qt().warn(wa, "cancel animation"), this.dc(!1, 0));
                }
              }),
              (i.mc = function (t, i) {
                var n, r;
                if (t.duration > 0) {
                  if (
                    ...
                    try {
                      ...
                      return (
                        Qt().error(wa, "step curve failed: " + t, t),
                        void this.dc(!1, 0)
                      );
                    }
                } else (n = 1), (r = 1);
                ...
                try {
                  ...
                  return (
                    Qt().error(wa, "step mutate failed: " + t, t),
                    void this.dc(!1, 0)
                  );
                }
              }),
        ...
        var Oa = (function () {
            function t(t) {
              ...
              (this.bc = s),
                ...
                (this.gc = new Er()),
                (this.yc = new Er()),
                (this.wc = this.Ac.bind(this)),
                (this.xc = function () {
                  return i.yc.fire();
                }),
                (this.Ec = 0),
                (this.Oc = !1),
                Ii(n, this.Pc.bind(this)),
                vn(n).then(function () {
            ...
            return (
              ...
              (i.Pc = function () {
                if (!this.Oc) {
                  ...
                  var t = this.win.document,
                    i = t.body;
                  t.documentElement.appendChild(this.bc),
              ...
              (i.connect = function () {
                this.win.addEventListener("resize", this.xc),
                  this.bc.addEventListener("scroll", this.wc);
              }),
              (i.disconnect = function () {
                this.win.removeEventListener("resize", this.xc),
                  this.bc.removeEventListener("scroll", this.wc);
              }),
              ...
              (i.updatePaddingTop = function (t) {
                (this.Ec = t), Sr(this.bc, { "padding-top": Cr(t) });
              }),
              ...
              (i.disableScroll = function () {
                this.bc.classList.add("i-amphtml-scroll-disabled");
              }),
              (i.resetScroll = function () {
                this.bc.classList.remove("i-amphtml-scroll-disabled");
              }),
              ...
              (i.getScrollTop = function () {
                return this.bc.scrollTop;
              }),
              (i.getScrollLeft = function () {
                return 0;
              }),
              (i.getScrollWidth = function () {
                return this.bc.scrollWidth;
              }),
              (i.getScrollHeight = function () {
                return this.bc.scrollHeight;
              }),
              ...
              (i.setScrollTop = function (t) {
                this.bc.scrollTop = t || 1;
              }),
              (i.Ac = function (t) {
                0 == this.bc.scrollTop &&
                  ((this.bc.scrollTop = 1), t && t.preventDefault()),
                  t && this.gc.fire();
              }),
          ...
          Ia = (function () {
            ...
            return (
              ...
              (i.connect = function () {
                this.win.addEventListener("scroll", this.wc),
                  this.win.addEventListener("resize", this.xc);
              }),
              (i.disconnect = function () {
                this.win.removeEventListener("scroll", this.wc),
                  this.win.removeEventListener("resize", this.xc);
              }),
              (i.ensureReadyForElements = function () {}),
              (i.getBorderTop = function () {
        ...
        var Ra = (function () {
          function t(t, i, n) {
            ...
            (this.ampdoc = t),
              ...
              (this.kc = !1),
              (this._c = null),
              (this.Ec = Number(n.getParam("paddingTop") || 0)),
              (this.Rc = 0),
              (this.ge = ar(e)),
              (this.vo = dr(e)),
              (this.Nc = !1),
              ...
              (this.zc = void 0),
              (this.Uc = null),
              this.$e.onMessage("viewport", this.Lc.bind(this)),
              this.$e.onMessage("scroll", this.Hc.bind(this)),
              this.$e.onMessage("disableScroll", this.Gc.bind(this)),
              this.$e.isEmbedded() && this.Es.updatePaddingTop(this.Ec),
              this.Es.onScroll(this.Vc.bind(this)),
              this.Es.onResize(this.Fc.bind(this)),
              this.onScroll(this.Bc.bind(this)),
              (this.lu = !1),
              this.ampdoc.onVisibilityChanged(this.qc.bind(this)),
              this.qc();
            ...
            if (
              ...
              this.Es.overrideGlobalScrollTo())
            )
              try {
          ...
          return (
            ...
            (i.ensureReadyForElements = function () {
              this.Es.ensureReadyForElements();
            }),
            (i.qc = function () {
              ...
              t != this.lu &&
                ...
                t
                  ? (this.Es.connect(),
                    this.pr && this.Fc(),
                    this.Sc && ((this.Sc = null), this.getScrollTop()))
                  : this.Es.disconnect());
            }),
            ...
            (i.getScrollTop = function () {
              return (
                null == this.Sc && (this.Sc = this.Es.getScrollTop()), this.Sc
              );
            }),
            (i.getScrollLeft = function () {
              return (
                null == this._c && (this._c = this.Es.getScrollLeft()), this._c
              );
            }),
            (i.setScrollTop = function (t) {
              (this.Sc = null), this.Es.setScrollTop(t);
            }),
            ...
            (i.getScrollWidth = function () {
              return this.Es.getScrollWidth();
            }),
            (i.getScrollHeight = function () {
              return this.Es.getScrollHeight();
            }),
            (i.getContentHeight = function () {
              return this.Es.getContentHeight();
            }),
            (i.contentHeightChanged = function () {
              this.Es.contentHeightChanged();
            }),
            (i.getRect = function () {
              if (null == this.Mc) {
                var t = this.getScrollTop(),
                  ...
                  n = this.getSize();
                this.Mc = zi(i, t, n.width, n.height);
              }
              return this.Mc;
            }),
            (i.getLayoutRect = function (t) {
              ...
              if (r) {
                var e = this.Es.getLayoutRect(t, 0, 0),
                  s = this.Es.getLayoutRect(r, i, n);
                return zi(
              ...
              return this.Es.getLayoutRect(t, i, n);
            }),
            (i.getClientRectAsync = function (t) {
              var i = this.vo.measurePromise(function () {
                  return t.getBoundingClientRect();
                }),
                n = this.Es.getRootClientRectAsync(),
                r = Sn(t, this.ampdoc.win);
              return (
                r &&
                  (n = this.vo.measurePromise(function () {
            ...
            (i.supportsPositionFixed = function () {
              return this.Es.supportsPositionFixed();
            }),
            (i.isDeclaredFixed = function (t) {
              return !!this.Uc && this.Uc.isDeclaredFixed(t);
            }),
            (i.scrollIntoView = function (t) {
              var i = this;
              return this.Wc(t).then(function (n) {
                return i.$c(t, n);
              });
            }),
            (i.$c = function (t, i) {
              var n = this,
                r = this.Es.getLayoutRect(t).top,
                e = Sa(this.ampdoc.win, i);
              c(function () {
                return Math.max(0, r - n.Ec - e);
              }).then(function (t) {
                return n.Kc(i, t);
              });
            }),
            ...
            (i.animateScrollWithinParent = function (t, i, n, r, e) {
              var s = this;
              Zt(!e || void 0 !== r);
              var u = this.Es.getLayoutRect(t),
                o = (this.Yc(i) ? this.getSize() : this.getLayoutRect(i))
                  .height,
                h = this.ampdoc.win,
                a = Sa(h, i),
                c = (function (t, i) {
              ...
              return (
                ...
                this.Jc(i).then(function (t) {
                  var n = u.top - s.Ec + f,
                    o = Math.max(0, n);
                  if (o != t) return s.Xc(i, t, o, r, e);
                })
              );
            }),
            (i.Xc = function (t, i, n, r) {
              var e = this,
                s =
                  arguments.length > 4 && void 0 !== arguments[4]
                    ? arguments[4]
            ...
            (i.Wc = function (t) {
              var i = this;
              return this.vo.measurePromise(function () {
                return (
                  yi(t, ".i-amphtml-scrollable") || i.Es.getScrollingElement()
                );
              });
            }),
            (i.Kc = function (t, i) {
              this.Yc(t)
                ? this.Es.setScrollTop(i)
                : this.vo.mutate(function () {
                    t.scrollTop = i;
                  });
            }),
            (i.Jc = function (t) {
              ...
              return this.Yc(t)
                ...
                : this.vo.measurePromise(function () {
                    return t.scrollTop;
                  });
            }),
            (i.Yc = function (t) {
              return t == this.Es.getScrollingElement();
            }),
            (i.getScrollingElement = function () {
              return this.zn
                ? this.zn
                : (this.zn = this.Es.getScrollingElement());
            }),
            ...
            (i.onResize = function (t) {
              return this.yc.add(t);
            }),
            (i.enterLightboxMode = function (t, i) {
              return (
                this.$e.sendMessage("requestFullOverlay", {}, !0),
                this.enterOverlayMode(),
                this.Uc && this.Uc.enterLightbox(t, i),
                t && this.maybeEnterFieLightboxMode(t),
                this.Es.updateLightboxMode(!0)
              );
            }),
            (i.leaveLightboxMode = function (t) {
              return (
                this.$e.sendMessage("cancelFullOverlay", {}, !0),
                this.Uc && this.Uc.leaveLightbox(),
                this.leaveOverlayMode(),
                t && this.maybeLeaveFieLightboxMode(t),
                this.Es.updateLightboxMode(!1)
              );
            }),
            ...
            (i.disableScroll = function () {
              ...
              this.vo.measure(function () {
                ...
                this.vo.mutate(function () {
                  Rr(r, "margin-right", t, "px"), i.Es.disableScroll();
                });
            }),
            (i.resetScroll = function () {
              var t = this,
              ...
              this.vo.mutate(function () {
                Rr(i, "margin-right", ""), t.Es.resetScroll();
              });
            }),
            ...
            (i.restoreOriginalTouchZoom = function () {
              return void 0 !== this.zc && this.tf(this.zc);
            }),
            (i.updateFixedLayer = function () {
              return this.Uc ? this.Uc.update() : h();
            }),
            (i.addToFixedLayer = function (t, i) {
              return this.Uc ? this.Uc.addElement(t, i) : h();
            }),
            (i.removeFromFixedLayer = function (t) {
              this.Uc && this.Uc.removeElement(t);
            }),
            (i.createFixedLayer = function (t) {
              ...
              (this.Uc = new t(
                this.ampdoc,
                this.vo,
                this.Es.getBorderTop(),
                this.Ec,
                this.Es.requiresFixedLayerTransfer(),
              )),
                this.ampdoc.whenReady().then(function () {
                  return i.Uc.setup();
                });
            ...
            (i.tf = function (t) {
              ...
              return !(
                !i ||
                i.content == t ||
                (Qt().fine(Ma, "changed viewport meta to:", t),
                (i.content = t),
                0)
              );
            }),
            (i.Zc = function () {
              return Ni(this.ampdoc.win)
                ? null
                : (void 0 === this.jc &&
                    ((this.jc = this.Ic.querySelector("meta[name=viewport]")),
                    this.jc && (this.zc = this.jc.content)),
                  this.jc);
            }),
            (i.Hc = function (t) {
              var i = t.scrollTop;
            ...
            (i.Lc = function (t) {
              ...
              if (
                null != n &&
                n != this.Ec &&
                ((this.Rc = this.Ec), (this.Ec = n), this.Uc)
              ) {
                var u = this.Uc.animateFixedElements(this.Ec, this.Rc, r, e, s);
                n < this.Rc
                  ? this.Es.hideViewerHeader(s, this.Rc)
                  : u.then(function () {
                      i.Es.showViewerHeader(s, n);
                    });
              }
            }),
            (i.Gc = function (t) {
            ...
            (i.Vc = function () {
              var t = this;
              (this.Mc = null), this.Cc++, (this._c = this.Es.getScrollLeft());
              var i = this.Es.getScrollTop();
              if (!(i < 0)) {
                if (((this.Sc = i), !this.Nc)) {
                  this.Nc = !0;
                  var n = Date.now();
                  this.ge.delay(function () {
                    t.vo.measure(function () {
                      t.zu(n, i);
                    });
                  }, 36);
                }
            ...
            (i.zu = function (t, i) {
              ...
              e != t && (s = (r - i) / (e - t)),
                ...
                Math.abs(s) < 0.03
                  ? (this.if(!1, s), (this.Nc = !1))
                  : this.ge.delay(function () {
                      return n.vo.measure(n.zu.bind(n, e, r));
                    }, 20);
            }),
            (i.Bc = function () {
              var t = this;
          ...
          Na = (function () {
            function t(t) {
              (this.win = t),
                ...
                (this.hf = null),
                (this.af = null),
                (this.cf = this.ff.bind(this)),
                (this.lf = new Cu(this.win, this.cf, 16)),
                (this.vf = new Cu(this.win, this.cf, 40)),
                (this.df = this.mf.bind(this)),
                this.nf.isSingleDoc()
                  ? this.nf.getSingleDoc().onVisibilityChanged(this.df)
                  : jr(this.win.document, this.df);
            }
            var i = t.prototype;
            return (
              (i.dispose = function () {
                Ur(this.win.document, this.df);
              }),
              (i.mf = function () {
                this.Ae && this.pf();
              }),
              (i.run = function (t, i) {
                this.qi.push(t), this.ro.push(i || void 0), this.Xi();
              }),
              (i.runPromise = function (t, i) {
                if ((this.run(t, i), this.hf)) return this.hf;
                var n = new a();
                return (this.af = n.resolve), (this.hf = n.promise);
              }),
              ...
              (i.bf = function (t) {
                ...
                if (this.nf.isSingleDoc())
                  return this.nf.getSingleDoc().isVisible();
                if (t) {
                  var i = this.nf.getAmpDocIfAvailable(t);
              ...
              (i.Xi = function () {
                this.Ae || ((this.Ae = !0), this.pf());
              }),
              (i.pf = function () {
                this.bf()
                  ? (this.rf(this.cf), this.vf.schedule())
                  : this.lf.schedule();
              }),
              (i.ff = function () {
                this.vf.cancel(), (this.Ae = !1);
                var t = this.af,
                  i = this.ro,
                  n = this.qi;
                (this.af = null),
                ...
                for (var r = 0; r < n.length; r++)
                  n[r].measure &&
                    (Da(n[r].measure, i[r]) || (n[r].mutate = void 0));
          ...
          La = (function () {
            function t(t) {
              (this.win = t),
                ...
                Qt().fine(Ua, "touch detected:", this.Pf),
                (this.Tf = !1),
                this.win.document.addEventListener("keydown", this.gf),
                this.win.document.addEventListener("mousedown", this.wf),
                (this.If = !0),
                (this.Mf = 0),
                (this.Sf = new Er()),
                (this.kf = new Er()),
                ...
                this.Pf &&
                  ((this.If = !this.Pf),
                  (this.xf = this.Rf.bind(this)),
                  Je(t.document, "mousemove", this.xf));
            }
            var i = t.prototype;
            return (
              (i.setupInputModeClasses = function (t) {
                ...
                this.onTouchDetected(function (n) {
                  i.Nf(t, "amp-mode-touch", n);
                }, !0),
                  this.onMouseDetected(function (n) {
                    i.Nf(t, "amp-mode-mouse", n);
                  }, !0),
                  this.onKeyboardStateChanged(function (n) {
                    i.Nf(t, "amp-mode-keyboard-active", n);
                  }, !0);
              }),
              ...
              (i.onTouchDetected = function (t, i) {
                return i && t(this.isTouchDetected()), this.Sf.add(t);
              }),
              (i.isMouseDetected = function () {
                return this.If;
              }),
              (i.onMouseDetected = function (t, i) {
                return i && t(this.isMouseDetected()), this.kf.add(t);
              }),
              (i.isKeyboardActive = function () {
                return this.Tf;
              }),
              (i.onKeyboardStateChanged = function (t, i) {
                return i && t(this.isKeyboardActive()), this._f.add(t);
              }),
              (i.Nf = function (t, i, n) {
                var r = this;
              ...
              (i.Rf = function (t) {
                ...
                if (
                  ...
                  var n;
                  this.Of ||
                    ((this.Of = this.Cf.bind(this)),
                    (this.Ef = this.Df.bind(this)));
              ...
              (i.Df = function () {
                this.Mf++,
                  this.Mf <= 3
                    ? Je(this.win.document, "mousemove", this.xf)
          ...
          Va = (function () {
            function t(t) {
              (this.jf = t.document),
                ...
                (this.Lf = {}),
                (this.xo = sr(t)),
                (this.Uf[vs(t.location.href).origin] = !0),
                (this.Hf = (function (t) {
                  if (!Ga) {
            ...
            return (
              ...
              (i.Vt = function (t, i, n) {
                if (this.Gf(i)) {
                  var r = vs(i).origin,
                    e = Date.now(),
                    s = this.Uf[r];
                  if (s && e < s) n && (this.Uf[r] = e + Ha);
                  else {
                    var u,
                      o = n ? Ha : 1e4;
                    (this.Uf[r] = e + o),
                      this.Hf.preconnect ||
                        ((u = this.jf.createElement("link")).setAttribute(
                          "rel",
                          "dns-prefetch",
                        ),
                        u.setAttribute("href", r),
                        this.zf.appendChild(u));
                    var h = this.jf.createElement("link");
              ...
              (i.Ff = function (t) {
                ...
                i.setAttribute("href", t),
                  this.Hf.onlyValidAs ? (i.as = "fetch") : (i.as = ""),
              ...
              (i.Vf = function (t, i) {
                if (
                  !this.Hf.preconnect &&
                  (this.xo.isSafari() || this.xo.isIos())
                ) {
                  var n = Date.now();
                  this.Uf[i] = n + Ha;
                  var r =
        ...
        var Ya = (function () {
          function t(t) {
            ...
            if (
              ...
              this.Gd.rejectSignal(Zi, r), this.Gd.rejectSignal(nn, r);
            }
          ...
          return (
            (i.coreServicesAvailable = function () {
              ...
              (this.wi = Wn(i)),
                ...
                (this.Nd = Zn(this.wi)),
                (this.Ld =
                  this.$e.isEmbedded() && "1" === this.$e.getParam("csi")),
                this.wi.onVisibilityChanged(this.flush.bind(this)),
                this.Bm();
              var n = this.$e.whenMessagingReady();
              return (
                this.wi.whenFirstVisible().then(function () {
                  t.tick("ofv"), t.flush();
                }),
                (this.Jd || this.Wd) && this.wi.onVisibilityChanged(this.$d),
                n
                  ? n
                      .then(function () {
                        t.tickDelta("msr", t.win.performance.now()),
                          t.tick("timeOrigin", void 0, t.Td);
                        var i = t.wi.getMetaByName("amp-usqp");
                        return (
                          i &&
                            i.split(",").forEach(function (i) {
            ...
            (i.Vv = function () {
              var t = this.wi.getVisibilityState();
              return t === xr || t === wr;
            }),
            (i.$d = function () {
              this.Vv() && (this.Gv(), this.Gm());
            }),
            (i.Wv = function () {
              if (!this.Zd) {
                this.Zd = !0;
                var t = this.win,
                  i = parseInt(
                    Nr(t, t.document.body).getPropertyValue(
                      "--google-font-exp",
                    ),
                    10,
                  );
              ...
              this.wi.whenFirstVisible().then(function () {
                ...
                this.Xv().then(function () {
                  if (i) {
                    ...
                    t.wi.whenFirstVisible().then(function () {
                      t.tickDelta(rn, r);
                    }),
                      t.$v(r),
                      t.mark(rn);
            ...
            (i.Xv = function () {
              var t = this;
              return this.Qt.whenFirstPass().then(function () {
                var i,
            ...
            (i.tick = function (t, i, n) {
              ...
              null != i
                ...
                this.win.dispatchEvent(
                  We(this.win, "perf", { label: t, delta: r }),
                ),
                this.Dd && this.Ld
                  ? this.$e.sendMessage("tick", e)
                  : this.Kv(e),
                this.Gd.signal(t, r);
            }),
            (i.mark = function (t) {
            ...
            (i.tickSinceVisible = function (t, i) {
              var n,
                ...
                s = this.Td + e,
                u =
                  null !== (n = this.$e) && void 0 !== n && n.isEmbedded()
                    ? null === (r = this.wi) || void 0 === r
                      ? void 0
            ...
            (i.flush = function () {
              this.Dd &&
                this.Ld &&
                (null == this.Vd && (this.Vd = Object.keys(this.Hd).join(",")),
                this.$e.sendMessage(
                  "sendCsi",
                  {
                    ampexp: this.Vd,
                    canonicalUrl: this.Nd.canonicalUrl,
                    eventid: this.Od,
                  },
                  !0,
                ));
            ...
            (i.$v = function (t) {
              this.$e &&
                this.$e.sendMessage("prerenderComplete", { value: t }, !0);
            }),
            (i.isPerformanceTrackingOn = function () {
              return this.Ld;
            }),
            (i.getMetric = function (t) {
              return this.Gd.whenSignal(t);
            }),
            t
          );
        })();
        ...
        var Ja = (function () {
            function t(t, i) {
              (this.tp = t),
                ...
                (this.Ag = !1),
                (this.xg = 0),
                (this.Eg = this.Wp.bind(this)),
                (this.Pg = this.Kp.bind(this)),
                (this.Og = this.Qp.bind(this)),
                (this.Ig = this.Mg.bind(this)),
                this.tp.addEventListener("touchstart", this.Eg, !0);
            }
            var i = t.prototype;
            return (
              (i.cleanup = function () {
                this.Tg(),
                  this.tp.removeEventListener("touchstart", this.Eg, !0);
              }),
              (i.Wp = function (t) {
                this.Ag ||
                  !t.touches ||
                  1 != t.touches.length ||
                  this.lo.getScrollTop() > 0 ||
                  this.Sg(t.touches[0].clientY);
              }),
              (i.Sg = function (t) {
                (this.Ag = !0),
                  (this.xg = t),
                  this.tp.addEventListener("touchmove", this.Pg, !0),
                  this.tp.addEventListener("touchend", this.Og, !0),
                  this.tp.addEventListener("touchcancel", this.Ig, !0);
              }),
              (i.Tg = function () {
                (this.Ag = !1),
                  (this.xg = 0),
                  this.tp.removeEventListener("touchmove", this.Pg, !0),
                  this.tp.removeEventListener("touchend", this.Og, !0),
                  this.tp.removeEventListener("touchcancel", this.Ig, !0);
              }),
              (i.Kp = function (t) {
                if (this.Ag) {
          ...
          nc = (function () {
            ...
            return (
              (i.registerExtension = function (t, i, n, r, e) {
                ...
                if (((o.latest = n), !o.loaded)) {
                  ...
                  try {
                    ...
                    (this.qf = null), (this.Wf = null), (this.$f = null);
                  }
                }
              }),
              (i.waitForExtension = function (t, i) {
                var n = this.Yf(this.Kf(t, i));
                return ar(this.win)
              ...
              (i.preloadExtension = function (t) {
                ...
                var n = this.Kf(t, i);
                return this.Jf(t, i, n), this.Yf(n);
              }),
              ...
              (i.addElement = function (t, i, n) {
                var r = this;
                (this.Xf(t).extension.elements[t] = {
              ...
              (i.addService = function (t, i) {
                this.Xf(t).extension.services.push({
                  serviceName: t,
                  serviceClass: i,
                }),
                  this.addDocFactory(function (n) {
              ...
              (i.addDocFactory = function (t, i) {
                var n = this.Xf(i);
                if (
                  (n.docFactories.push(t), this.qf && this.nf.isSingleDoc())
                ) {
                  var r = this.nf.getAmpDoc(this.win.document),
                    e = this.qf,
                    s = this.Wf,
                    u = this.$f || !1;
                  (r.declaresExtension(e, s) ||
                    (u && r.declaresExtension(e, tc)) ||
                    n.auto) &&
                    t(r);
                }
              }),
              ...
              (i.installExtensionInDoc = function (t, i) {
                ...
                return (
                  t.declareExtension(i, r),
                  this.Yf(this.Kf(i, r)).then(function () {
                    n.Kf(i, r).docFactories.forEach(function (n) {
                      try {
                        n(t);
                      } catch (t) {
              ...
              (i.Xf = function (t) {
                return (
                  this.qf || Qt().error(Qa, "unknown extension for ", t),
                  this.Kf(this.qf || "_UNKNOWN_", this.Wf || "")
                );
              }),
              (i.Yf = function (t) {
                if (!t.promise)
        ...
        function vc(t, i) {
          ...
          !(function (t, i) {
            ...
            sr(t).isIos() &&
              Rr(t.document.documentElement, "cursor", "pointer");
          var a = tr(t);
          return (
        ...
        function dc(t, i) {
          return (
            ...
            (!!i.m ||
              ("2208121708000" != i.v &&
                (tr(t).reloadExtension(i.n, i.ev, i.l), !0)))
          );
        }
        function mc(t, i) {
                                  ...
                                  !(function (t, i) {
                                    if (i) {
                                      var n = i.location,
                                        r = i.tracking_url || n;
                                      if (
                                        (r && !xs(r) && (new Image().src = r),
                                        n)
                                      ) {
                                        if (!t.history.replaceState) return;
                                        var e = vr(t.document.documentElement),
                                          s = gs(
                                            zr.getLocation(t).href,
                                            yt(vs(n).search),
                                          );
                      ...
                      Ut(t, r) && (n = "0" !== r.validate),
                        n &&
                          (function (t, i) {
                            ...
                            t.document,
                            "".concat(Mt, "/v0/validator_wasm.js"),
                          ).then(function () {
                    ...
                    Mi(t)
                      ...
                      .then(function (n) {
                        (rs = !0),
                          ...
                          n.length > 0 &&
                            or(t.documentElement).schedulePass(1, !0);
                        try {
                          var r = er(i);
                          r.tick("mbv"), r.flush();
                        } catch (t) {}
        ...
        Xs(self.document, function () {
          ...
          self.console &&
            (console.info || console.log).call(
              console,
              "Powered by AMP ⚡ HTML – Version ".concat("2208121708000"),
              self.location.href,
            ),
