...
document.querySelector(".share .sharebtn").addEventListener("click", () => {
  if (navigator.canShare) {
    ...
    navigator.clipboard
      .writeText(window.location.href.toString() + "&hideshare=true")
      .then(
        function () {
          document.querySelector(".share button").innerText = "已複製到剪貼板";
        },
        function (err) {
          document.querySelector(".share button").innerText =
            "分享失敗，請自行複製網址分享。";
        },
      );
  }
