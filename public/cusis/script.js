...
function submitform(form) {
  ...
  document
    .querySelectorAll("h1, p, .Notes[downloadhide]")
    .forEach((element) => {
  ...
  if (window.location.hostname == webhostname) xhr.open("POST", "api.php");
  else xhr.open("POST", "https://" + webhostname + "/cusis/api.php");
