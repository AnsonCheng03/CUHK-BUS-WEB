...
<body>
  ...
  <div class="lang-selector nav">
    <button onclick="lang_change('tc');" />中文</button>
    <button onclick="lang_change('en');" />ENG</button>
  </div>
  ...
  <form name="bussearch" method="post" onsubmit="return submitform(this,'.routeresult','routesearch/index.php')" autocomplete="off">
    ...
    <div class="switch-toggle">
      ...
      <input disable id="realtime" name="mode" type="radio" value="realtime" onclick="window.location.href = 'realtime.php<?php if( $lang == 1 ) echo '?lang=en';?>';"/>
