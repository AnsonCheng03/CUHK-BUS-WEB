...
<div id="HomeScreenPrompt">
  <div class="desc">
    ...
    <button
      onclick=' document.getElementById("HomeScreenPrompt").style.display="none" ; localStorage.setItem("dismisshomescreen", new Date());'><b><?php echo $translation["cancel_btntxt"][$lang] ?></b></button>
  </div>
  <div class="dsecimg">
    <div>
...
<footer>
  ...
  <h2><a style="color: #685206; text-decoration: none;"
      href="https://github.com/AnsonCheng03"><?php echo $translation["author-notes"][$lang] ?>@AnsonCheng03</a></h2>
