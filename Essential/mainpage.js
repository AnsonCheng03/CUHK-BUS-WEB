...
function getLocation(item) {
  ...
  document.getElementById("details-box").style.display = 'table'; 
...
function mode_change(mode) {
  var prevmode = document.querySelector('input[name="mode"]:checked').value;
  append_query("mode",mode);
}
